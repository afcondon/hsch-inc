...
import * as Hylograph_Simulation_Core_Tick from "../Hylograph.Simulation.Core.Tick/index.js";
import * as Hylograph_Simulation_Core_Types from "../Hylograph.Simulation.Core.Types/index.js";
...
var transitionTo = function (targetScene) {
    return function (engineRef) {
        return function __do() {
            ...
            throw new Error("Failed pattern match at Hylograph.Simulation.Core.Engine (line 184, column 3 - line 211, column 27): " + [ state.transition.constructor.name ]);
        };
    };
};
...
var defaultTransitionDelta = /* #__PURE__ */ Hylograph_Simulation_Core_Tick.ticksForDuration(2000);
    ...
    return function (engineRef) {
        return function (state) {
            return function __do() {
                ...
                (function () {
                    if (t.targetScene.stableMode instanceof Hylograph_Simulation_Core_Types.Physics) {
                        return state.adapter.reheat();
                    };
                    if (t.targetScene.stableMode instanceof Hylograph_Simulation_Core_Types.Static) {
                        return Data_Unit.unit;
                    };
                    throw new Error("Failed pattern match at Hylograph.Simulation.Core.Engine (line 282, column 3 - line 284, column 30): " + [ t.targetScene.stableMode.constructor.name ]);
                })();
...
var runInterpolationEngine = function (t) {
    return function (engineRef) {
        return function (state) {
            ...
            var easedProgress = Hylograph_Simulation_Core_Tick.easeInOutCubic(newProgress);
            return function __do() {
...
var tick = function (engineRef) {
    return function __do() {
        ...
        throw new Error("Failed pattern match at Hylograph.Simulation.Core.Engine (line 225, column 3 - line 232, column 17): " + [ state.transition.constructor.name ]);
    };
};
export {
    createEngine,
...
export {
    Physics,
    Static
} from "../Hylograph.Simulation.Core.Types/index.js";
