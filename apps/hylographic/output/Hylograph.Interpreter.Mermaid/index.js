...
var showElement = function (v) {
    ...
    throw new Error("Failed pattern match at Hylograph.Interpreter.Mermaid (line 71, column 1 - line 71, column 37): " + [ v.constructor.name ]);
};
...
var formatAttrSource = function (name) {
    return function (v) {
        ...
        throw new Error("Failed pattern match at Hylograph.Interpreter.Mermaid (line 104, column 25 - line 110, column 36): " + [ v.constructor.name ]);
    };
};
var formatAttribute = function (v) {
    if (v instanceof Hylograph_Internal_Attribute.StaticAttr) {
        return v.value0;
    };
    if (v instanceof Hylograph_Internal_Attribute.DataAttr) {
        return formatAttrSource(v.value0)(v.value1);
    };
    if (v instanceof Hylograph_Internal_Attribute.IndexedAttr) {
        return formatAttrSource(v.value0)(v.value1);
    };
    if (v instanceof Hylograph_Internal_Attribute.AnimatedAttr) {
        return v.value0.name + "(anim)";
    };
    if (v instanceof Hylograph_Internal_Attribute.AnimatedCompound) {
        return v.value0.name + "(compound-anim)";
    };
    throw new Error("Failed pattern match at Hylograph.Interpreter.Mermaid (line 95, column 19 - line 100, column 91): " + [ v.constructor.name ]);
};
    ...
    return function (parentId) {
        ...
        if (tree instanceof Hylograph_AST.Node) {
            var nodeLabel = (function () {
                ...
                throw new Error("Failed pattern match at Hylograph.Interpreter.Mermaid (line 124, column 21 - line 126, column 47): " + [ tree.value0.name.constructor.name ]);
            })();
            ...
            return bind2(addNode(fullLabel)("elementNode"))(function (nodeId) {
                return discard2((function () {
                    ...
                    throw new Error("Failed pattern match at Hylograph.Interpreter.Mermaid (line 135, column 5 - line 137, column 27): " + [ parentId.constructor.name ]);
                })())(function () {
        ...
        if (tree instanceof Hylograph_AST.Join) {
            ...
            return bind2(addNode(joinLabel)("joinNode"))(function (joinId) {
                return discard2((function () {
                    ...
                    throw new Error("Failed pattern match at Hylograph.Interpreter.Mermaid (line 149, column 5 - line 151, column 27): " + [ parentId.constructor.name ]);
                })())(function () {
                    return bind2(addNode("template(datum) \u2192")("templateNode"))(function (templateLabel) {
                        return discard2(addEdge(joinId)(templateLabel))(function () {
                            return discard2((function () {
                                ...
                                throw new Error("Failed pattern match at Hylograph.Interpreter.Mermaid (line 158, column 5 - line 163, column 18): " + [ v.constructor.name ]);
                            })())(function () {
                                return pure2(joinId);
                            });
                        });
        ...
        if (tree instanceof Hylograph_AST.NestedJoin) {
            ...
            return bind2(addNode(joinLabel)("nestedJoinNode"))(function (joinId) {
                return discard2((function () {
                    ...
                    throw new Error("Failed pattern match at Hylograph.Interpreter.Mermaid (line 173, column 5 - line 175, column 27): " + [ parentId.constructor.name ]);
                })())(function () {
                                ...
                                return discard2(addEdge(decomposeId)(templateId))(function () {
                                    return discard2((function () {
                                        ...
                                        if (v instanceof Data_Maybe.Just) {
                                            ...
                                            throw new Error("Failed pattern match at Hylograph.Interpreter.Mermaid (line 190, column 9 - line 195, column 22): " + [ v1.constructor.name ]);
                                        };
                                        throw new Error("Failed pattern match at Hylograph.Interpreter.Mermaid (line 186, column 5 - line 195, column 22): " + [ v.constructor.name ]);
                                    })())(function () {
                                        return pure2(joinId);
                                    });
                                });
        ...
        if (tree instanceof Hylograph_AST.UpdateJoin) {
            ...
            return bind2(addNode(joinLabel)("updateJoinNode"))(function (joinId) {
                return discard2((function () {
                    ...
                    throw new Error("Failed pattern match at Hylograph.Interpreter.Mermaid (line 210, column 5 - line 212, column 27): " + [ parentId.constructor.name ]);
                })())(function () {
                    return bind2(addNode("template(datum) \u2192")("templateNode"))(function (templateLabel) {
                        return discard2(addEdge(joinId)(templateLabel))(function () {
                            return discard2((function () {
                                ...
                                throw new Error("Failed pattern match at Hylograph.Interpreter.Mermaid (line 219, column 5 - line 224, column 18): " + [ v.constructor.name ]);
                            })())(function () {
                                return pure2(joinId);
                            });
                        });
        ...
        if (tree instanceof Hylograph_AST.UpdateNestedJoin) {
            ...
            return bind2(addNode(joinLabel)("updateNestedJoinNode"))(function (joinId) {
                return discard2((function () {
                    ...
                    throw new Error("Failed pattern match at Hylograph.Interpreter.Mermaid (line 239, column 5 - line 241, column 27): " + [ parentId.constructor.name ]);
                })())(function () {
                    return bind2(addNode("decompose(datum) \u2192")("decomposeNode"))(function (decomposeId) {
                        return discard2(addEdge(joinId)(decomposeId))(function () {
                                ...
                                return discard2(addEdge(decomposeId)(templateLabel))(function () {
                                    return discard2((function () {
                                        ...
                                        if (v instanceof Data_Maybe.Just) {
                                            ...
                                            throw new Error("Failed pattern match at Hylograph.Interpreter.Mermaid (line 256, column 9 - line 261, column 22): " + [ v1.constructor.name ]);
                                        };
                                        throw new Error("Failed pattern match at Hylograph.Interpreter.Mermaid (line 252, column 5 - line 261, column 22): " + [ v.constructor.name ]);
                                    })())(function () {
                                        return pure2(joinId);
                                    });
                                });
        ...
        if (tree instanceof Hylograph_AST.ConditionalRender) {
            ...
            return bind2(addNode(condLabel)("conditionalNode"))(function (condId) {
                return discard2((function () {
                    ...
                    throw new Error("Failed pattern match at Hylograph.Interpreter.Mermaid (line 271, column 5 - line 273, column 27): " + [ parentId.constructor.name ]);
                })())(function () {
        ...
        if (tree instanceof Hylograph_AST.LocalCoordSpace) {
            return bind2(addNode("LOCAL COORD SPACE")("coordSpaceNode"))(function (coordId) {
                return discard2((function () {
                    ...
                    throw new Error("Failed pattern match at Hylograph.Interpreter.Mermaid (line 289, column 5 - line 291, column 27): " + [ parentId.constructor.name ]);
                })())(function () {
        ...
        throw new Error("Failed pattern match at Hylograph.Interpreter.Mermaid (line 121, column 28 - line 296, column 17): " + [ tree.constructor.name ]);
    };
};
