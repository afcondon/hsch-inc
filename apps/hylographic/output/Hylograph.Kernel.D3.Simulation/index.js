...
import * as Hylograph_Kernel_D3_Core from "../Hylograph.Kernel.D3.Core/index.js";
import * as Hylograph_Kernel_D3_Types from "../Hylograph.Kernel.D3.Types/index.js";
...
var querySelectorElements = Hylograph_Kernel_D3_Core.querySelectorElements;
...
var invokeStopCallback = function (sim) {
    ...
    throw new Error("Failed pattern match at Hylograph.Kernel.D3.Simulation (line 504, column 26 - line 508, column 13): " + [ sim.callbacks.constructor.name ]);
};
var invokeStartCallback = function (sim) {
    ...
    throw new Error("Failed pattern match at Hylograph.Kernel.D3.Simulation (line 494, column 27 - line 498, column 13): " + [ sim.callbacks.constructor.name ]);
};
...
var defaultConfig = /* #__PURE__ */ (function () {
    return {
        alphaMin: Hylograph_Kernel_D3_Types.defaultSimParams.alphaMin,
        alphaDecay: Hylograph_Kernel_D3_Types.defaultSimParams.alphaDecay,
        alphaTarget: Hylograph_Kernel_D3_Types.defaultSimParams.alphaTarget,
        velocityDecay: Hylograph_Kernel_D3_Types.defaultSimParams.velocityDecay
    };
})();
...
var tick = function (sim) {
    return function __do() {
        ...
        Hylograph_Kernel_D3_Core.applyForces(forceHandles)(alpha)();
        Hylograph_Kernel_D3_Core.integratePositions(nodes)(sim.config.velocityDecay)();
        var newAlpha = Hylograph_Kernel_D3_Core.decayAlpha(alpha)(sim.config.alphaMin)(sim.config.alphaDecay)(sim.config.alphaTarget);
...
var start = function (sim) {
    return function __do() {
        ...
        return unless(alreadyRunning)(function __do() {
            ...
            var cancel = Hylograph_Kernel_D3_Core.startAnimation(function (v) {
                return function __do() {
            ...
            return function (mForceYHandle) {
                return function (sim) {
                    return function __do() {
                        ...
                        Hylograph_Kernel_D3_Core.initializeForce(forceXHandle)(currentNodes)();
                        for_2(mForceYHandle)(function (forceYHandle) {
                            return $$void(Hylograph_Kernel_D3_Core.initializeForce(forceYHandle)(currentNodes));
                        })();
                        return reheat(sim)();
                    };
                };
...
var attachPinningDrag = function (elements) {
    return function (sim) {
        return Hylograph_Kernel_D3_Core.attachPinningDrag(elements)(reheat(sim));
    };
};
var attachGroupDrag = function (elements) {
    return function (containerSelector) {
        return function (sim) {
            return Hylograph_Kernel_D3_Core.attachGroupDragWithReheat(elements)(containerSelector)(reheat(sim));
        };
    };
};
var attachDrag = function (elements) {
    return function (sim) {
        return Hylograph_Kernel_D3_Core.attachDragWithReheat(elements)(reheat(sim));
    };
};
...
var addForce = function (spec) {
    return function (sim) {
        var forceName = function (v) {
            if (v instanceof Hylograph_Kernel_D3_Types.ManyBody) {
                return v.value0;
            };
            if (v instanceof Hylograph_Kernel_D3_Types.Collide) {
                return v.value0;
            };
            if (v instanceof Hylograph_Kernel_D3_Types.Link) {
                return v.value0;
            };
            if (v instanceof Hylograph_Kernel_D3_Types.Center) {
                return v.value0;
            };
            if (v instanceof Hylograph_Kernel_D3_Types.PositionX) {
                return v.value0;
            };
            if (v instanceof Hylograph_Kernel_D3_Types.PositionY) {
                return v.value0;
            };
            if (v instanceof Hylograph_Kernel_D3_Types.Radial) {
                return v.value0;
            };
            throw new Error("Failed pattern match at Hylograph.Kernel.D3.Simulation (line 335, column 15 - line 342, column 20): " + [ v.constructor.name ]);
        };
        return function __do() {
            var nodes = Effect_Ref.read(sim.nodes)();
            var links = Effect_Ref.read(sim.links)();
            var handle = (function () {
                if (spec instanceof Hylograph_Kernel_D3_Types.ManyBody) {
                    var h = Hylograph_Kernel_D3_Core.createManyBody(spec.value1);
                    return Hylograph_Kernel_D3_Core.initializeForce(h)(nodes)();
                };
                if (spec instanceof Hylograph_Kernel_D3_Types.Collide) {
                    var h = Hylograph_Kernel_D3_Core.createCollide(spec.value1);
                    return Hylograph_Kernel_D3_Core.initializeForce(h)(nodes)();
                };
                if (spec instanceof Hylograph_Kernel_D3_Types.Link) {
                    var h = Hylograph_Kernel_D3_Core.createLink(spec.value1);
                    return Hylograph_Kernel_D3_Core.initializeLinkForce(h)(nodes)(links)();
                };
                if (spec instanceof Hylograph_Kernel_D3_Types.Center) {
                    var h = Hylograph_Kernel_D3_Core.createCenter(spec.value1);
                    return Hylograph_Kernel_D3_Core.initializeForce(h)(nodes)();
                };
                if (spec instanceof Hylograph_Kernel_D3_Types.PositionX) {
                    var h = Hylograph_Kernel_D3_Core.createForceX(spec.value1);
                    return Hylograph_Kernel_D3_Core.initializeForce(h)(nodes)();
                };
                if (spec instanceof Hylograph_Kernel_D3_Types.PositionY) {
                    var h = Hylograph_Kernel_D3_Core.createForceY(spec.value1);
                    return Hylograph_Kernel_D3_Core.initializeForce(h)(nodes)();
                };
                if (spec instanceof Hylograph_Kernel_D3_Types.Radial) {
                    var h = Hylograph_Kernel_D3_Core.createRadial(spec.value1);
                    return Hylograph_Kernel_D3_Core.initializeForce(h)(nodes)();
                };
                throw new Error("Failed pattern match at Hylograph.Kernel.D3.Simulation (line 302, column 13 - line 329, column 35): " + [ spec.constructor.name ]);
            })();
