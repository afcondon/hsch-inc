    ...
    return pure((function () {
        if (fc.forceType instanceof ForceManyBody) {
            if (fc.filter instanceof Data_Maybe.Just) {
                return Hylograph_ForceEngine_Core.createManyBodyFiltered({
            ...
            if (fc.filter instanceof Data_Maybe.Nothing) {
                return Hylograph_ForceEngine_Core.createManyBody({
                    strength: valueToNumber(fc.strength),
                    theta: fc.theta,
                    distanceMin: fc.distanceMin,
                    distanceMax: fc.distanceMax
        ...
        if (fc.forceType instanceof ForceCollide) {
            if (fc.radius instanceof Static) {
                return Hylograph_ForceEngine_Core.createCollide({
            ...
            if (fc.radius instanceof Dynamic) {
                return Hylograph_ForceEngine_Core.createCollideDynamic({
        ...
        if (fc.forceType instanceof ForceLink) {
            return Hylograph_ForceEngine_Core.createLink({
        ...
        if (fc.forceType instanceof ForceCenter) {
            return Hylograph_ForceEngine_Core.createCenter({
        ...
        if (fc.forceType instanceof ForcePositionX) {
            if (fc.x instanceof Static) {
                return Hylograph_ForceEngine_Core.createForceX({
                    x: fc.x.value0,
                    strength: valueToNumber(fc.strength)
                });
            };
            if (fc.x instanceof Dynamic) {
                return Hylograph_ForceEngine_Core.createForceXDynamic({
        ...
        if (fc.forceType instanceof ForcePositionY) {
            if (fc.y instanceof Static) {
                return Hylograph_ForceEngine_Core.createForceY({
                    y: fc.y.value0,
                    strength: valueToNumber(fc.strength)
                });
            };
            if (fc.y instanceof Dynamic) {
                return Hylograph_ForceEngine_Core.createForceYDynamic({
        ...
        if (fc.forceType instanceof ForceRadial) {
            if (fc.filter instanceof Data_Maybe.Just) {
                return Hylograph_ForceEngine_Core.createRadialFiltered({
            ...
            if (fc.filter instanceof Data_Maybe.Nothing) {
                return Hylograph_ForceEngine_Core.createRadial({
                    radius: valueToNumber(fc.radius),
                    x: valueToNumber(fc.x),
                    y: valueToNumber(fc.y),
                    strength: valueToNumber(fc.strength)
        ...
        return function __do() {
            ...
            for_(setupConfig.forces)(function (fc) {
                return function __do() {
                    ...
                    (function () {
                        if (fc.forceType instanceof ForceLink) {
                            return Hylograph_ForceEngine_Core.initializeLinkForce(handle)(nodes)(links)();
                        };
                        return Hylograph_ForceEngine_Core.initializeForce(handle)(nodes)();
                    })();
        ...
        return function (desiredLinks) {
            return function (sim) {
                return function __do() {
                    ...
                    Hylograph_ForceEngine_Core.initializeNodes(nodeResult.merged)();
