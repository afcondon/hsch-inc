...
var updateNodePosition = function (positions) {
    return function (node) {
        ...
        throw new Error("Failed pattern match at Hylograph.ForceEngine.WASMEngine (line 278, column 3 - line 280, column 20): " + [ v.constructor.name ]);
    };
};
var updatePositions = function (sim) {
    return function (positions) {
        return function __do() {
            ...
            return Hylograph_ForceEngine_WASM.syncPositionsToWasm(sim.wasmSim)(updatedNodes)();
        };
    };
};
    ...
    return function (nodes) {
        var syncFixedNode = function (wasm) {
            return function (v) {
                ...
                if ($34) {
                    return Hylograph_ForceEngine_WASM.fixNode(wasm)(v.value0)(v.value1.fx)(v.value1.fy);
                };
                return Hylograph_ForceEngine_WASM.unfixNode(wasm)(v.value0);
            };
        };
...
var setNodes = function (nodes) {
    return function (sim) {
        return function __do() {
            Hylograph_ForceEngine_WASM.setNodeCount(sim.wasmSim)(Data_Array.length(nodes))();
            Hylograph_ForceEngine_WASM.syncPositionsToWasm(sim.wasmSim)(nodes)();
...
var setLinks = function (links) {
    return function (sim) {
        return function __do() {
            Hylograph_ForceEngine_WASM.setLinksFromRecords(sim.wasmSim)(links)();
...
var enableForces = function (sim) {
    return Hylograph_ForceEngine_WASM.enableForces(sim.wasmSim);
};
    ...
    return function (links) {
        return function (config) {
            return function __do() {
                ...
                Hylograph_ForceEngine_WASM.configureManyBody(wasmSim)(config.manyBody)();
                Hylograph_ForceEngine_WASM.configureLinks(wasmSim)(config.links)();
                Hylograph_ForceEngine_WASM.configureCenter(wasmSim)(config.center)();
                Hylograph_ForceEngine_WASM.enableForces(wasmSim)({
...
var configureManyBody = function (sim) {
    return function (config) {
        return Hylograph_ForceEngine_WASM.configureManyBody(sim.wasmSim)(config);
    };
};
var configureLinks = function (sim) {
    return function (config) {
        return Hylograph_ForceEngine_WASM.configureLinks(sim.wasmSim)(config);
    };
};
var configureCenter = function (sim) {
    return function (config) {
        return Hylograph_ForceEngine_WASM.configureCenter(sim.wasmSim)(config);
    };
};
...
var applyFirstMatchingRule = function (rules) {
    return function (node) {
        ...
        throw new Error("Failed pattern match at Hylograph.ForceEngine.WASMEngine (line 303, column 3 - line 305, column 20): " + [ v.constructor.name ]);
    };
};
