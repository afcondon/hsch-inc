...
var setNodes = function (nodes) {
    return function (sim) {
        return function __do() {
            Hylograph_ForceEngine_Core.initializeNodes(nodes)();
...
var querySelectorElements = Hylograph_ForceEngine_Core.querySelectorElements;
...
var defaultConfig = /* #__PURE__ */ (function () {
    return {
        alphaMin: Hylograph_ForceEngine_Types.defaultSimParams.alphaMin,
        alphaDecay: Hylograph_ForceEngine_Types.defaultSimParams.alphaDecay,
        alphaTarget: Hylograph_ForceEngine_Types.defaultSimParams.alphaTarget,
        velocityDecay: Hylograph_ForceEngine_Types.defaultSimParams.velocityDecay
    };
})();
...
var tick = function (sim) {
    return function __do() {
        ...
        Hylograph_ForceEngine_Core.applyForces(forceHandles)(alpha)();
        Hylograph_ForceEngine_Core.integratePositions(nodes)(sim.config.velocityDecay)();
        var newAlpha = Hylograph_ForceEngine_Core.decayAlpha(alpha)(sim.config.alphaMin)(sim.config.alphaDecay)(sim.config.alphaTarget);
...
var start = function (sim) {
    return function __do() {
        ...
        return unless(alreadyRunning)(function __do() {
            ...
            var cancel = Hylograph_ForceEngine_Core.startAnimation(function (v) {
                return function __do() {
            ...
            return function (mForceYHandle) {
                return function (sim) {
                    return function __do() {
                        ...
                        Hylograph_ForceEngine_Core.initializeForce(forceXHandle)(currentNodes)();
                        for_2(mForceYHandle)(function (forceYHandle) {
                            return $$void(Hylograph_ForceEngine_Core.initializeForce(forceYHandle)(currentNodes));
                        })();
                        return reheat(sim)();
                    };
                };
...
var attachPinningDrag = function (elements) {
    return function (sim) {
        return Hylograph_ForceEngine_Core.attachPinningDrag(elements)(reheat(sim));
    };
};
var attachGroupDrag = function (elements) {
    return function (containerSelector) {
        return function (sim) {
            return Hylograph_ForceEngine_Core.attachGroupDragWithReheat(elements)(containerSelector)(reheat(sim));
        };
    };
};
var attachDrag = function (elements) {
    return function (sim) {
        return Hylograph_ForceEngine_Core.attachDragWithReheat(elements)(reheat(sim));
    };
};
...
var addForce = function (spec) {
    return function (sim) {
        var forceName = function (v) {
            if (v instanceof Hylograph_ForceEngine_Types.ManyBody) {
                return v.value0;
            };
            if (v instanceof Hylograph_ForceEngine_Types.Collide) {
                return v.value0;
            };
            if (v instanceof Hylograph_ForceEngine_Types.Link) {
                return v.value0;
            };
            if (v instanceof Hylograph_ForceEngine_Types.Center) {
                return v.value0;
            };
            if (v instanceof Hylograph_ForceEngine_Types.PositionX) {
                return v.value0;
            };
            if (v instanceof Hylograph_ForceEngine_Types.PositionY) {
                return v.value0;
            };
            if (v instanceof Hylograph_ForceEngine_Types.Radial) {
                return v.value0;
            };
        ...
        return function __do() {
            ...
            var handle = (function () {
                if (spec instanceof Hylograph_ForceEngine_Types.ManyBody) {
                    var h = Hylograph_ForceEngine_Core.createManyBody(spec.value1);
                    return Hylograph_ForceEngine_Core.initializeForce(h)(nodes)();
                };
                if (spec instanceof Hylograph_ForceEngine_Types.Collide) {
                    var h = Hylograph_ForceEngine_Core.createCollide(spec.value1);
                    return Hylograph_ForceEngine_Core.initializeForce(h)(nodes)();
                };
                if (spec instanceof Hylograph_ForceEngine_Types.Link) {
                    var h = Hylograph_ForceEngine_Core.createLink(spec.value1);
                    return Hylograph_ForceEngine_Core.initializeLinkForce(h)(nodes)(links)();
                };
                if (spec instanceof Hylograph_ForceEngine_Types.Center) {
                    var h = Hylograph_ForceEngine_Core.createCenter(spec.value1);
                    return Hylograph_ForceEngine_Core.initializeForce(h)(nodes)();
                };
                if (spec instanceof Hylograph_ForceEngine_Types.PositionX) {
                    var h = Hylograph_ForceEngine_Core.createForceX(spec.value1);
                    return Hylograph_ForceEngine_Core.initializeForce(h)(nodes)();
                };
                if (spec instanceof Hylograph_ForceEngine_Types.PositionY) {
                    var h = Hylograph_ForceEngine_Core.createForceY(spec.value1);
                    return Hylograph_ForceEngine_Core.initializeForce(h)(nodes)();
                };
                if (spec instanceof Hylograph_ForceEngine_Types.Radial) {
                    var h = Hylograph_ForceEngine_Core.createRadial(spec.value1);
                    return Hylograph_ForceEngine_Core.initializeForce(h)(nodes)();
                };
