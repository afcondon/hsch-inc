...
var extendBasis = function (basis) {
    return function (p) {
            ...
            var findTwoCircleBasis = function ($copy_i) {
                ...
                function $tco_loop(i) {
                    ...
                    if (Data_Boolean.otherwise) {
                        ...
                        throw new Error("Failed pattern match at DataViz.Layout.Hierarchy.Pack (line 560, column 13 - line 567, column 52): " + [ v.constructor.name ]);
                    };
            ...
            var findThreeCircleBasis = function ($copy_i) {
                ...
                function $tco_loop(i) {
                    ...
                    if (Data_Boolean.otherwise) {
                        ...
                        throw new Error("Failed pattern match at DataViz.Layout.Hierarchy.Pack (line 573, column 13 - line 575, column 54): " + [ v.constructor.name ]);
                    };
        ...
        throw new Error("Failed pattern match at DataViz.Layout.Hierarchy.Pack (line 543, column 1 - line 543, column 54): " + [ basis.constructor.name, p.constructor.name ]);
    };
};
                                ...
                                function $tco_loop(j, k, sj, sk) {
                                    ...
                                    if ($215) {
                                        ...
                                        if (v instanceof Data_Maybe.Just) {
                                            ...
                                            throw new Error("Failed pattern match at DataViz.Layout.Hierarchy.Pack (line 294, column 13 - line 300, column 37): " + [ v1.constructor.name ]);
                                        };
                                        if (v instanceof Data_Maybe.Nothing) {
                                            $tco_done = true;
                                            return NoCollision.value;
                                        };
                                        throw new Error("Failed pattern match at DataViz.Layout.Hierarchy.Pack (line 288, column 7 - line 301, column 31): " + [ v.constructor.name ]);
                                    };
                                    ...
                                    if (v instanceof Data_Maybe.Just) {
                                        ...
                                        throw new Error("Failed pattern match at DataViz.Layout.Hierarchy.Pack (line 310, column 13 - line 316, column 37): " + [ v1.constructor.name ]);
                                    };
                                    if (v instanceof Data_Maybe.Nothing) {
                                        $tco_done = true;
                                        return NoCollision.value;
                                    };
                                    throw new Error("Failed pattern match at DataViz.Layout.Hierarchy.Pack (line 304, column 7 - line 317, column 31): " + [ v.constructor.name ]);
                                };
                                while (!$tco_done) {
            ...
            return function ($copy_bId) {
                return function ($copy_state) {
                    ...
                    function $tco_loop(maxRetries, newCircle, aId, bId, state) {
                        ...
                        throw new Error("Failed pattern match at DataViz.Layout.Hierarchy.Pack (line 368, column 1 - line 368, column 91): " + [ maxRetries.constructor.name, newCircle.constructor.name, aId.constructor.name, bId.constructor.name, state.constructor.name ]);
                    };
                    while (!$tco_done) {
