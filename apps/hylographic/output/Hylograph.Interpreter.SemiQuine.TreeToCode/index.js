...
var staticValueToCode = function (v) {
    ...
    throw new Error("Failed pattern match at Hylograph.Interpreter.SemiQuine.TreeToCode (line 222, column 21 - line 225, column 38): " + [ v.constructor.name ]);
};
var showElemType = function (v) {
    ...
    throw new Error("Failed pattern match at Hylograph.Interpreter.SemiQuine.TreeToCode (line 257, column 16 - line 277, column 31): " + [ v.constructor.name ]);
};
var showAttrValue = function (v) {
    ...
    throw new Error("Failed pattern match at Hylograph.Interpreter.SemiQuine.TreeToCode (line 281, column 17 - line 284, column 27): " + [ v.constructor.name ]);
};
var indent = function (n) {
    return Data_String_Common.joinWith("")(Data_Array.replicate(n)("  "));
};
var attrSourceToCode = function (v) {
    if (v instanceof Hylograph_Internal_Attribute.UnknownSource) {
        return "d.<?>";
    };
    if (v instanceof Hylograph_Internal_Attribute.StaticSource) {
        return "num " + v.value0;
    };
    if (v instanceof Hylograph_Internal_Attribute.FieldSource) {
        return "field @\"" + (v.value0 + "\"");
    };
    if (v instanceof Hylograph_Internal_Attribute.ExprSource) {
        return v.value0;
    };
    if (v instanceof Hylograph_Internal_Attribute.IndexSource) {
        return "index";
    };
    if (v instanceof Hylograph_Internal_Attribute.OpaqueSource) {
        return "OPAQUE -- requires metadata";
    };
    throw new Error("Failed pattern match at Hylograph.Interpreter.SemiQuine.TreeToCode (line 230, column 20 - line 236, column 48): " + [ v.constructor.name ]);
};
...
var attrToCode = function (maybeSample) {
    return function (attr) {
        ...
        if (attr instanceof Hylograph_Internal_Attribute.DataAttr) {
            ...
            throw new Error("Failed pattern match at Hylograph.Interpreter.SemiQuine.TreeToCode (line 196, column 5 - line 202, column 57): " + [ maybeSample.constructor.name ]);
        };
        if (attr instanceof Hylograph_Internal_Attribute.IndexedAttr) {
            ...
            throw new Error("Failed pattern match at Hylograph.Interpreter.SemiQuine.TreeToCode (line 205, column 5 - line 210, column 57): " + [ maybeSample.constructor.name ]);
        };
        ...
        throw new Error("Failed pattern match at Hylograph.Interpreter.SemiQuine.TreeToCode (line 190, column 31 - line 218, column 148): " + [ attr.constructor.name ]);
    };
};
...
var phaseToCode = function (v) {
    return function (v1) {
        ...
        throw new Error("Failed pattern match at Hylograph.Interpreter.SemiQuine.TreeToCode (line 300, column 1 - line 300, column 82): " + [ v.constructor.name, v1.constructor.name ]);
    };
};
...
var attrsToLines = function (maybeSample) {
    return function (attrs) {
        return function (indentLevel) {
            ...
            throw new Error("Failed pattern match at Hylograph.Interpreter.SemiQuine.TreeToCode (line 181, column 10 - line 186, column 50): " + [ v.constructor.name ]);
        };
    };
};
        ...
        return function (indentLevel) {
            if (tree instanceof Hylograph_AST.Node) {
                var elemCode = (function () {
                    ...
                    throw new Error("Failed pattern match at Hylograph.Interpreter.SemiQuine.TreeToCode (line 40, column 18 - line 42, column 59): " + [ tree.value0.name.constructor.name ]);
                })();
                var childrenCode = (function () {
                    ...
                    if (v === 1) {
                        ...
                        throw new Error("Failed pattern match at Hylograph.Interpreter.SemiQuine.TreeToCode (line 50, column 14 - line 54, column 24): " + [ v1.constructor.name ]);
                    };
            ...
            if (tree instanceof Hylograph_AST.Join) {
                var templateCode = (function () {
                    ...
                    throw new Error("Failed pattern match at Hylograph.Interpreter.SemiQuine.TreeToCode (line 69, column 22 - line 74, column 78): " + [ v.constructor.name ]);
                })();
                return append1([ indent(indentLevel) + ("T.joinData \"" + (tree.value0.name + ("\" \"" + (tree.value0.key + "\" data_ $ \\d ->")))) ])(templateCode);
            };
            if (tree instanceof Hylograph_AST.NestedJoin) {
                var templateCode = (function () {
                    var v = Data_Array.head(tree.value0.joinData);
                    if (v instanceof Data_Maybe.Just) {
                        ...
                        throw new Error("Failed pattern match at Hylograph.Interpreter.SemiQuine.TreeToCode (line 84, column 14 - line 89, column 88): " + [ v1.constructor.name ]);
                    };
                    if (v instanceof Data_Maybe.Nothing) {
                        return [ indent(indentLevel + 1 | 0) + "-- (no data to evaluate template)" ];
                    };
                    throw new Error("Failed pattern match at Hylograph.Interpreter.SemiQuine.TreeToCode (line 81, column 22 - line 91, column 78): " + [ v.constructor.name ]);
                })();
                return append1([ indent(indentLevel) + ("T.nestedJoin \"" + (tree.value0.name + ("\" \"" + (tree.value0.key + "\" data_ decompose $ \\inner ->")))) ])(templateCode);
            };
            if (tree instanceof Hylograph_AST.UpdateJoin) {
                ...
                var templateCode = (function () {
                    ...
                    throw new Error("Failed pattern match at Hylograph.Interpreter.SemiQuine.TreeToCode (line 100, column 22 - line 105, column 78): " + [ maybeDatum.constructor.name ]);
                })();
            ...
            if (tree instanceof Hylograph_AST.UpdateNestedJoin) {
                var maybeDatum = (function () {
                    ...
                    throw new Error("Failed pattern match at Hylograph.Interpreter.SemiQuine.TreeToCode (line 117, column 20 - line 119, column 27): " + [ v.constructor.name ]);
                })();
                var templateCode = (function () {
                    if (maybeDatum instanceof Data_Maybe.Just) {
                        var templateTree = tree.value0.template(maybeDatum.value0);
                    ...
                    throw new Error("Failed pattern match at Hylograph.Interpreter.SemiQuine.TreeToCode (line 121, column 22 - line 126, column 78): " + [ maybeDatum.constructor.name ]);
                })();
                var behaviorsCode = gupBehaviorsToLines(maybeDatum)(tree.value0.behaviors)(indentLevel + 1 | 0);
            ...
            if (tree instanceof Hylograph_AST.ConditionalRender) {
            ...
            if (tree instanceof Hylograph_AST.LocalCoordSpace) {
            ...
            throw new Error("Failed pattern match at Hylograph.Interpreter.SemiQuine.TreeToCode (line 35, column 42 - line 150, column 21): " + [ tree.constructor.name ]);
        };
    };
};
        ...
        return function (ind) {
            ...
            var renderChild = function (v) {
                return function (v1) {
                    ...
                    throw new Error("Failed pattern match at Hylograph.Interpreter.SemiQuine.TreeToCode (line 163, column 8 - line 167, column 20): " + [ v2.constructor.name ]);
                };
            };
