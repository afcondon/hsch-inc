...
import * as Hylograph_Transition_RAF from "../Hylograph.Transition.RAF/index.js";
...
var stop = function (v) {
    return function __do() {
        ...
        return when(state.running)(function __do() {
            for_1(state.frameId)(Hylograph_Transition_RAF.cancelAnimationFrame)();
...
var scheduleFrame = function (v) {
    return function __do() {
        var frameId = Hylograph_Transition_RAF.requestAnimationFrame(runFrame(v))();
        return Effect_Ref.modify_(function (v1) {
            return {
                consumers: v1.consumers,
                lastTimestamp: v1.lastTimestamp,
...
var start = function (v) {
    return function __do() {
        ...
        return unless(state.running)(function __do() {
            var now = Hylograph_Transition_RAF.performanceNow();
            Effect_Ref.modify_(function (v1) {
                return {
                    consumers: v1.consumers,
                    frameId: v1.frameId,
