...
var getLinksTo = function (nodeId) {
    return function (model) {
        ...
        throw new Error("Failed pattern match at Hylograph.Data.Graph (line 206, column 3 - line 208, column 24): " + [ v.constructor.name ]);
    };
};
var getLinksFrom = function (nodeId) {
    return function (model) {
        ...
        throw new Error("Failed pattern match at Hylograph.Data.Graph (line 196, column 3 - line 198, column 24): " + [ v.constructor.name ]);
    };
};
        ...
        return function (links) {
            var addToArray = function (v) {
                return function (v1) {
                    ...
                    throw new Error("Failed pattern match at Hylograph.Data.Graph (line 112, column 5 - line 112, column 68): " + [ v.constructor.name, v1.constructor.name ]);
                };
            };
        ...
        return function (model) {
            var addToArray = function (v) {
                return function (v1) {
                    ...
                    throw new Error("Failed pattern match at Hylograph.Data.Graph (line 170, column 5 - line 170, column 68): " + [ v.constructor.name, v1.constructor.name ]);
                };
            };
            var targetId = config.getLinkTarget(link);
            var sourceId = config.getLinkSource(link);
