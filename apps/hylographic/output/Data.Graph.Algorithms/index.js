            ...
            return function ($copy_target) {
                return function ($copy_acc) {
                    ...
                    function $tco_loop(stack, target, acc) {
                        ...
                        throw new Error("Failed pattern match at Data.Graph.Algorithms (line 604, column 5 - line 610, column 42): " + [ v.constructor.name ]);
                    };
                    while (!$tco_done) {
        ...
        var tarjanDFS = function (state) {
            return function (v) {
                var successors = (function () {
                    ...
                    throw new Error("Failed pattern match at Data.Graph.Algorithms (line 558, column 20 - line 560, column 63): " + [ v1.constructor.name ]);
                })();
                var state$prime = {
                    sccs: state.sccs,
        ...
        var processSuccessor = function (v) {
            return function (state) {
                return function (w) {
                    ...
                    throw new Error("Failed pattern match at Data.Graph.Algorithms (line 575, column 5 - line 589, column 19): " + [ v1.constructor.name ]);
                };
            };
        };
        var initialState = {
        ...
        return mapFlipped(graph.nodes)(function (node) {
            return {
                ...
                depends: (function () {
                    ...
                    throw new Error("Failed pattern match at Data.Graph.Algorithms (line 260, column 16 - line 262, column 49): " + [ v.constructor.name ]);
                })()
            };
        });
    };
            ...
            var go = function ($copy_visited) {
                return function ($copy_frontier) {
                    ...
                    function $tco_loop(visited, frontier) {
                        ...
                        throw new Error("Failed pattern match at Data.Graph.Algorithms (line 102, column 5 - line 102, column 43): " + [ visited.constructor.name, frontier.constructor.name ]);
                    };
                    while (!$tco_done) {
    ...
    return function (graph) {
        ...
        return fromFoldable2(mapFlipped(graph.nodes)(function (node) {
            var outDeg = (function () {
                ...
                throw new Error("Failed pattern match at Data.Graph.Algorithms (line 451, column 20 - line 453, column 45): " + [ v.constructor.name ]);
            })();
        ...
        var findMostCommon = function (labels) {
            ...
            var maxEntry = Data_Array.foldl(function (best) {
                return function (v) {
                    ...
                    throw new Error("Failed pattern match at Data.Graph.Algorithms (line 778, column 11 - line 783, column 24): " + [ best.constructor.name ]);
                };
            ...
            return Data_Array.foldl(function (acc) {
                return function (node) {
                    ...
                    var newLabel = (function () {
                        ...
                        throw new Error("Failed pattern match at Data.Graph.Algorithms (line 753, column 24 - line 755, column 26): " + [ mostCommon.constructor.name ]);
                    })();
        ...
        var iterate = function ($copy_remaining) {
            return function ($copy_labels) {
                ...
                function $tco_loop(remaining, labels) {
                    ...
                    throw new Error("Failed pattern match at Data.Graph.Algorithms (line 736, column 5 - line 736, column 53): " + [ remaining.constructor.name, labels.constructor.name ]);
                };
                while (!$tco_done) {
...
var getAllEdges = function (dictOrd) {
    ...
    return function (graph) {
        return Data_Array.concat(mapFlipped(graph.nodes)(function (source) {
            ...
            throw new Error("Failed pattern match at Data.Graph.Algorithms (line 238, column 5 - line 241, column 28): " + [ v.constructor.name ]);
        }));
    };
};
                    ...
                    return Data_Array.foldl(function (a) {
                        return function (target) {
                            var targetOutDeg = (function () {
                                ...
                                throw new Error("Failed pattern match at Data.Graph.Algorithms (line 805, column 29 - line 807, column 36): " + [ v1.constructor.name ]);
                            })();
    ...
    return function (graph) {
        var dfs = function (state) {
            return function (node) {
                if (member(node)(state.gray)) {
                    ...
                    throw new Error("Failed pattern match at Data.Graph.Algorithms (line 306, column 12 - line 308, column 54): " + [ cycleStart.constructor.name ]);
                };
                ...
                if (Data_Boolean.otherwise) {
                    ...
                    var neighbors = (function () {
                        ...
                        throw new Error("Failed pattern match at Data.Graph.Algorithms (line 319, column 23 - line 321, column 53): " + [ v.constructor.name ]);
                    })();
                    ...
                    throw new Error("Failed pattern match at Data.Graph.Algorithms (line 324, column 11 - line 332, column 18): " + [ state$prime$prime.cycle.constructor.name ]);
                };
                throw new Error("Failed pattern match at Data.Graph.Algorithms (line 301, column 3 - line 332, column 18): " + [ state.constructor.name, node.constructor.name ]);
            };
        };
        var initialState = {
        ...
        var result = Data_Array.foldl(function (state) {
            return function (node) {
                ...
                throw new Error("Failed pattern match at Data.Graph.Algorithms (line 292, column 7 - line 297, column 21): " + [ state.cycle.constructor.name ]);
            };
        })(initialState)(graph.nodes);
        return result.cycle;
    };
...
var hasCycle = function (dictOrd) {
    ...
    return function (graph) {
        ...
        throw new Error("Failed pattern match at Data.Graph.Algorithms (line 278, column 18 - line 280, column 17): " + [ v.constructor.name ]);
    };
};
                    ...
                    var go = function ($copy_component) {
                        return function ($copy_frontier) {
                            ...
                            function $tco_loop(component, frontier) {
                                ...
                                throw new Error("Failed pattern match at Data.Graph.Algorithms (line 381, column 5 - line 389, column 58): " + [ component.constructor.name, frontier.constructor.name ]);
                            };
                            while (!$tco_done) {
...
var isConnected = function (dictOrd) {
    ...
    return function (graph) {
        ...
        throw new Error("Failed pattern match at Data.Graph.Algorithms (line 394, column 3 - line 398, column 38): " + [ v.constructor.name ]);
    };
};
        ...
        return function (graph) {
            ...
            var outDegrees = fromFoldable2(mapFlipped(graph.nodes)(function (node) {
                return new Data_Tuple.Tuple(node, (function () {
                    ...
                    throw new Error("Failed pattern match at Data.Graph.Algorithms (line 662, column 20 - line 664, column 41): " + [ v.constructor.name ]);
                })());
            }));
            var n = Data_Array.length(graph.nodes);
            ...
            var iterate = function ($copy_remaining) {
                return function ($copy_ranks) {
                    ...
                    function $tco_loop(remaining, ranks) {
                        ...
                        throw new Error("Failed pattern match at Data.Graph.Algorithms (line 669, column 5 - line 669, column 57): " + [ remaining.constructor.name, ranks.constructor.name ]);
                    };
                    while (!$tco_done) {
            ...
            return function (taskId) {
                ...
                if (v instanceof Data_Maybe.Just) {
                    var layer = (function () {
                        ...
                        throw new Error("Failed pattern match at Data.Graph.Algorithms (line 177, column 22 - line 179, column 36): " + [ v1.constructor.name ]);
                    })();
                    return insert(taskId)(layer)(accLayers);
                };
                throw new Error("Failed pattern match at Data.Graph.Algorithms (line 166, column 7 - line 180, column 47): " + [ v.constructor.name ]);
            };
        };
