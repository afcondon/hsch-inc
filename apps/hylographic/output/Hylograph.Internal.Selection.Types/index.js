...
var genericRenderContext_ = {
    to: function (x) {
        ...
        throw new Error("Failed pattern match at Hylograph.Internal.Selection.Types (line 179, column 1 - line 179, column 40): " + [ x.constructor.name ]);
    },
    from: function (x) {
...
var genericElementType_ = {
    to: function (x) {
        ...
        throw new Error("Failed pattern match at Hylograph.Internal.Selection.Types (line 213, column 1 - line 213, column 38): " + [ x.constructor.name ]);
    },
    from: function (x) {
        ...
        return function (v) {
            var mapSelectionImpl = function (v1) {
                return function (v2) {
                    ...
                    throw new Error("Failed pattern match at Hylograph.Internal.Selection.Types (line 85, column 5 - line 85, column 97): " + [ v1.constructor.name, v2.constructor.name ]);
                };
            };
...
var ordRenderContext = {
    compare: function (x) {
        return function (y) {
            ...
            throw new Error("Failed pattern match at Hylograph.Internal.Selection.Types (line 0, column 0 - line 0, column 0): " + [ x.constructor.name, y.constructor.name ]);
        };
    },
    Eq0: function () {
