...
var genericTreeAST_ = {
    to: function (x) {
        ...
        throw new Error("Failed pattern match at Hylograph.Interpreter.MetaAST (line 65, column 1 - line 65, column 34): " + [ x.constructor.name ]);
    },
    from: function (x) {
...
var showElemType = function (v) {
    ...
    throw new Error("Failed pattern match at Hylograph.Interpreter.MetaAST (line 216, column 1 - line 216, column 38): " + [ v.constructor.name ]);
};
var toAST = function (tree) {
    ...
    if (tree instanceof Hylograph_AST.UpdateJoin) {
        return new UpdateJoinAST({
            ...
            hasEnter: (function () {
                ...
                throw new Error("Failed pattern match at Hylograph.Interpreter.MetaAST (line 99, column 19 - line 101, column 27): " + [ tree.value0.behaviors.enter.constructor.name ]);
            })(),
            hasUpdate: (function () {
                ...
                throw new Error("Failed pattern match at Hylograph.Interpreter.MetaAST (line 102, column 20 - line 104, column 27): " + [ tree.value0.behaviors.update.constructor.name ]);
            })(),
            hasExit: (function () {
                ...
                throw new Error("Failed pattern match at Hylograph.Interpreter.MetaAST (line 105, column 18 - line 107, column 27): " + [ tree.value0.behaviors.exit.constructor.name ]);
            })(),
            hasTemplate: true
        });
    };
    if (tree instanceof Hylograph_AST.UpdateNestedJoin) {
        return new UpdateNestedJoinAST({
            ...
            hasEnter: (function () {
                ...
                throw new Error("Failed pattern match at Hylograph.Interpreter.MetaAST (line 116, column 19 - line 118, column 27): " + [ tree.value0.behaviors.enter.constructor.name ]);
            })(),
            hasUpdate: (function () {
                if (tree.value0.behaviors.update instanceof Data_Maybe.Just) {
                    return true;
                ...
                throw new Error("Failed pattern match at Hylograph.Interpreter.MetaAST (line 119, column 20 - line 121, column 27): " + [ tree.value0.behaviors.update.constructor.name ]);
            })(),
            hasExit: (function () {
                if (tree.value0.behaviors.exit instanceof Data_Maybe.Just) {
                    return true;
                ...
                throw new Error("Failed pattern match at Hylograph.Interpreter.MetaAST (line 122, column 18 - line 124, column 27): " + [ tree.value0.behaviors.exit.constructor.name ]);
            })(),
            hasTemplate: true
        });
    };
    ...
    throw new Error("Failed pattern match at Hylograph.Interpreter.MetaAST (line 69, column 14 - line 136, column 8): " + [ tree.constructor.name ]);
};
        ...
        return function (level) {
            if (tree instanceof NodeAST) {
                var nameStr = (function () {
                    ...
                    throw new Error("Failed pattern match at Hylograph.Interpreter.MetaAST (line 145, column 23 - line 147, column 37): " + [ tree.value0.name.constructor.name ]);
                })();
            ...
            throw new Error("Failed pattern match at Hylograph.Interpreter.MetaAST (line 143, column 30 - line 206, column 31): " + [ tree.constructor.name ]);
        };
    };
