    ...
    var go = function ($copy_acc) {
        return function ($copy_remaining) {
            ...
            function $tco_loop(acc, remaining) {
                ...
                throw new Error("Failed pattern match at Hylograph.Internal.Selection.Query (line 166, column 5 - line 173, column 40): " + [ v.constructor.name ]);
            };
            while (!$tco_done) {
...
var getElements = function (v) {
    ...
    throw new Error("Failed pattern match at Hylograph.Internal.Selection.Query (line 146, column 46 - line 150, column 35): " + [ v.constructor.name ]);
};
...
var getDocument = function (v) {
    ...
    throw new Error("Failed pattern match at Hylograph.Internal.Selection.Query (line 154, column 32 - line 158, column 40): " + [ v.constructor.name ]);
};
var findByData = function (predicate) {
    return function (v) {
        var v1 = (function () {
            ...
            throw new Error("Failed pattern match at Hylograph.Internal.Selection.Query (line 424, column 75 - line 425, column 28): " + [ v.constructor.name ]);
        })();
        ...
        if (maybeMatch instanceof Data_Maybe.Nothing) {
            return pure(Hylograph_Internal_Selection_Types.mkBoundSelection([  ])([  ])(v1.indices)(v1.document));
        };
        if (maybeMatch instanceof Data_Maybe.Just) {
            return pure(Hylograph_Internal_Selection_Types.mkBoundSelection([ maybeMatch.value0.value0 ])([ maybeMatch.value0.value1 ])(v1.indices)(v1.document));
        };
        throw new Error("Failed pattern match at Hylograph.Internal.Selection.Query (line 430, column 3 - line 432, column 86): " + [ maybeMatch.constructor.name ]);
    };
};
var filterByData = function (predicate) {
    return function (v) {
        var v1 = (function () {
            ...
            throw new Error("Failed pattern match at Hylograph.Internal.Selection.Query (line 396, column 75 - line 397, column 28): " + [ v.constructor.name ]);
        })();
        ...
        return pure(Hylograph_Internal_Selection_Types.mkBoundSelection(filteredElements)(filteredData)(v1.indices)(v1.document));
    };
};
...
var queryFirst = function (name) {
    return function (selector) {
        return function (selectionsMap) {
            ...
            throw new Error("Failed pattern match at Hylograph.Internal.Selection.Query (line 270, column 3 - line 275, column 81): " + [ v.constructor.name ]);
        };
    };
};
var queryIn = function (name) {
    return function (selector) {
        return function (selectionsMap) {
            ...
            throw new Error("Failed pattern match at Hylograph.Internal.Selection.Query (line 225, column 3 - line 230, column 41): " + [ v.constructor.name ]);
        };
    };
};
    ...
    return function __do() {
        var siblingArrays = traverse(function (element) {
            return function __do() {
                ...
                throw new Error("Failed pattern match at Hylograph.Internal.Selection.Query (line 514, column 5 - line 519, column 45): " + [ maybeParent.constructor.name ]);
            };
        })(elements)();
        ...
        var ancestorArrays = traverse(function (element) {
            var walkUp = function (elem) {
                return function __do() {
                    ...
                    throw new Error("Failed pattern match at Hylograph.Internal.Selection.Query (line 550, column 9 - line 554, column 42): " + [ v.constructor.name ]);
                };
            };
