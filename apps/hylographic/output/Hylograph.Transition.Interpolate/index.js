...
var interpolatableNumber = {
    interpolate: Hylograph_Transition_Tick.lerp
};
var interpolatableInt = {
    interpolate: Hylograph_Transition_Tick.lerpInt
};
var eqRGB = {
    eq: function (x) {
        return function (y) {
...
var lerpRGB = function (v) {
    return function (v1) {
        return function (t) {
            return {
                r: Hylograph_Transition_Tick.lerpInt(v.r)(v1.r)(t),
                g: Hylograph_Transition_Tick.lerpInt(v.g)(v1.g)(t),
                b: Hylograph_Transition_Tick.lerpInt(v.b)(v1.b)(t)
            };
        };
    };
};
...
var lerpPointXY = function (from) {
    return function (to) {
        return function (progress) {
            return {
                x: Hylograph_Transition_Tick.lerp(from.fromX)(to.toX)(progress.progressX),
                y: Hylograph_Transition_Tick.lerp(from.fromY)(to.toY)(progress.progressY)
            };
        };
    };
};
var lerpPoint = function (p1) {
    return function (p2) {
        return function (t) {
            return {
                x: Hylograph_Transition_Tick.lerp(p1.x)(p2.x)(t),
                y: Hylograph_Transition_Tick.lerp(p1.y)(p2.y)(t)
            };
        };
    };
};
    ...
    return function (v1) {
        return function (t) {
            ...
            return {
                ...
                s: Hylograph_Transition_Tick.lerp(v.s)(v1.s)(t),
                l: Hylograph_Transition_Tick.lerp(v.l)(v1.l)(t)
            };
        };
    };
};
