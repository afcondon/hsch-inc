...
var maxDepth = function (tree) {
    var go = function (d) {
        return function (t) {
            ...
            throw new Error("Failed pattern match at Hylograph.Data.DAGTree (line 251, column 10 - line 253, column 89): " + [ v.constructor.name ]);
        };
    };
    return go(0)(tree);
};
                    ...
                    return function (xMax) {
                        return function (t) {
                            ...
                            var y = (function () {
                                ...
                                throw new Error("Failed pattern match at Hylograph.Data.DAGTree (line 220, column 13 - line 223, column 44): " + [ layout.constructor.name ]);
                            })();
                            var x = (function () {
                                if (layout instanceof Data_Graph_Layout.Vertical) {
                                ...
                                throw new Error("Failed pattern match at Hylograph.Data.DAGTree (line 216, column 13 - line 219, column 43): " + [ layout.constructor.name ]);
                            })();
                            ...
                            var layoutChildren = function (v) {
                                return function (v1) {
                                    ...
                                    throw new Error("Failed pattern match at Hylograph.Data.DAGTree (line 231, column 9 - line 231, column 89): " + [ v.constructor.name, v1.constructor.name ]);
                                };
                            };
