...
import * as Hylograph_Scale from "../Hylograph.Scale/index.js";
...
var ticksWithLabels = function (count) {
    return function (specifier) {
        return function (scale) {
            var tickVals = Hylograph_Scale.ticks(count)(scale);
            var formatter = Hylograph_Scale.tickFormat(count)(specifier)(scale);
            return mapFlipped(tickVals)(function (t) {
                return {
                    position: Hylograph_Scale.applyScale(scale)(t),
                    label: formatter(t)
                };
            });
        };
...
var tickPositions = function (count) {
    return function (scale) {
        return mapFlipped(Hylograph_Scale.ticks(count)(scale))(Hylograph_Scale.applyScale(scale));
    };
};
...
var scaleMidpoint = function (scale) {
    return Hylograph_Scale.applyScale(scale)(0.5);
};
var scaleExtent = function (scale) {
    var v1 = Hylograph_Scale.applyScale(scale)(1.0);
    var v0 = Hylograph_Scale.applyScale(scale)(0.0);
    return {
        min: min1(v0)(v1),
        max: max(v0)(v1)
    };
...
var sampleWithDomain = function (n) {
    return function (scale) {
        ...
        return mapFlipped(ts)(function (t) {
            return new Data_Tuple.Tuple(t, Hylograph_Scale.applyScale(scale)(t));
        });
    };
};
    ...
    return function (start) {
        return function (end) {
            return function (scale) {
                ...
                return mapFlipped(ts)(Hylograph_Scale.applyScale(scale));
            };
        };
    };
};
...
var roundModifier = /* #__PURE__ */ Hylograph_Scale.round(true);
...
var normalize = function (minVal) {
    return function (maxVal) {
        return Hylograph_Scale.domain([ minVal, maxVal ])(Hylograph_Scale.range([ 0.0, 1.0 ])($foreign.createLinear));
    };
};
var niceModifier = Hylograph_Scale.nice;
...
var clampModifier = /* #__PURE__ */ Hylograph_Scale.clamp(true);
