...
import * as Hylograph_ForceEngine_WASM from "../Hylograph.ForceEngine.WASM/index.js";
var pure = /* #__PURE__ */ Control_Applicative.pure(Effect.applicativeEffect);
var eq = /* #__PURE__ */ Data_Eq.eq(Hylograph_ForceEngine_Setup.eqForceType);
...
var warnIfDynamic = function (v) {
    return function (v1) {
        if (v instanceof Hylograph_ForceEngine_Setup.Dynamic) {
            return Effect_Console.warn("WASM Setup: " + (v1 + " uses dynamic value, falling back to static"));
        };
        if (v instanceof Hylograph_ForceEngine_Setup.Static) {
            return pure(Data_Unit.unit);
        };
...
var tickN = function (n) {
    return function (sim) {
        return function __do() {
            var alpha = Hylograph_ForceEngine_WASM.tickN(sim.wasmSim)(n)();
            var nodes = Effect_Ref.read(sim.nodesRef)();
            var updatedNodes = Hylograph_ForceEngine_WASM.syncPositionsFromWasm(sim.wasmSim)(nodes)();
...
var tick = function (sim) {
    return function __do() {
        var alpha = Hylograph_ForceEngine_WASM.tick(sim.wasmSim)();
        var nodes = Effect_Ref.read(sim.nodesRef)();
        var updatedNodes = Hylograph_ForceEngine_WASM.syncPositionsFromWasm(sim.wasmSim)(nodes)();
        Effect_Ref.write(updatedNodes)(sim.nodesRef)();
        return alpha;
...
var reheat = function (sim) {
    return Hylograph_ForceEngine_WASM.reheat(sim.wasmSim);
};
var isWasmReady = Hylograph_ForceEngine_WASM.isWasmReady;
var isRunning = function (sim) {
    return Hylograph_ForceEngine_WASM.isRunning(sim.wasmSim);
};
var initWasm = Hylograph_ForceEngine_WASM.initWasm;
var getNodes = function (sim) {
    return function __do() {
        var nodes = Effect_Ref.read(sim.nodesRef)();
        return Hylograph_ForceEngine_WASM.syncPositionsFromWasm(sim.wasmSim)(nodes)();
    };
};
var getAlpha = function (sim) {
    return Hylograph_ForceEngine_WASM.getAlpha(sim.wasmSim);
};
var free = function (sim) {
    return Hylograph_ForceEngine_WASM.free(sim.wasmSim);
};
var createEmpty = function __do() {
    var wasmSim = Hylograph_ForceEngine_WASM.create(0)();
...
var create = function (nodes) {
    return function (links) {
        return function __do() {
            var wasmSim = Hylograph_ForceEngine_WASM.create(Data_Array.length(nodes))();
            Hylograph_ForceEngine_WASM.syncPositionsToWasm(wasmSim)(nodes)();
            Hylograph_ForceEngine_WASM.setLinksFromRecords(wasmSim)(links)();
...
var configureManyBody = function (wasmSim) {
    return function (fc) {
        return function __do() {
            ...
            return Hylograph_ForceEngine_WASM.configureManyBody(wasmSim)({
                strength: Hylograph_ForceEngine_Setup.valueToNumber(fc.strength),
                theta: fc.theta,
...
var configureLinks = function (wasmSim) {
    return function (fc) {
        return function __do() {
            ...
            return Hylograph_ForceEngine_WASM.configureLinks(wasmSim)({
                distance: Hylograph_ForceEngine_Setup.valueToNumber(fc.distance),
                strength: Hylograph_ForceEngine_Setup.valueToNumber(fc.strength),
...
var configureCenter = function (wasmSim) {
    return function (fc) {
        return function __do() {
            ...
            return Hylograph_ForceEngine_WASM.configureCenter(wasmSim)({
                x: Hylograph_ForceEngine_Setup.valueToNumber(fc.x),
                y: Hylograph_ForceEngine_Setup.valueToNumber(fc.y),
                strength: Hylograph_ForceEngine_Setup.valueToNumber(fc.strength)
            })();
        };
    };
...
var applySetup = function (setupConfig) {
    return function (sim) {
        var forces = Hylograph_ForceEngine_Setup.getForces(setupConfig);
        var manyBodyForce = Data_Array.find(function (f) {
            return eq(f.forceType)(Hylograph_ForceEngine_Setup.ForceManyBody.value);
        })(forces);
        var collideForce = Data_Array.find(function (f) {
            return eq(f.forceType)(Hylograph_ForceEngine_Setup.ForceCollide.value);
        })(forces);
        var linkForce = Data_Array.find(function (f) {
            return eq(f.forceType)(Hylograph_ForceEngine_Setup.ForceLink.value);
        })(forces);
        var centerForce = Data_Array.find(function (f) {
            return eq(f.forceType)(Hylograph_ForceEngine_Setup.ForceCenter.value);
        })(forces);
        var posXForce = Data_Array.find(function (f) {
            return eq(f.forceType)(Hylograph_ForceEngine_Setup.ForcePositionX.value);
        })(forces);
        var posYForce = Data_Array.find(function (f) {
            return eq(f.forceType)(Hylograph_ForceEngine_Setup.ForcePositionY.value);
        })(forces);
        var radialForce = Data_Array.find(function (f) {
            return eq(f.forceType)(Hylograph_ForceEngine_Setup.ForceRadial.value);
        })(forces);
        return function __do() {
            ...
            Hylograph_ForceEngine_WASM.enableForces(sim.wasmSim)({
            ...
            var params = Hylograph_ForceEngine_Setup.getParams(setupConfig);
            Hylograph_ForceEngine_WASM.setAlpha(sim.wasmSim)(params.alpha)();
            Hylograph_ForceEngine_WASM.setAlphaDecay(sim.wasmSim)(params.alphaDecay)();
            return Hylograph_ForceEngine_WASM.setVelocityDecay(sim.wasmSim)(params.velocityDecay)();
        };
    };
};
        ...
        return function (desiredLinks) {
            return function (sim) {
                return function __do() {
                    ...
                    var nodeResult = Hylograph_ForceEngine_Setup.computeNodeGUP(currentNodes)(desiredNodes);
                    ...
                    when(currentCount !== newCount)(Hylograph_ForceEngine_WASM.setNodeCount(sim.wasmSim)(newCount))();
                    Hylograph_ForceEngine_WASM.syncPositionsToWasm(sim.wasmSim)(nodeResult.merged)();
                    var linkResult = Hylograph_ForceEngine_Setup.computeLinkGUP(currentLinks)(desiredLinks);
                    Effect_Ref.write(desiredLinks)(sim.linksRef)();
                    Hylograph_ForceEngine_WASM.setLinksFromRecords(sim.wasmSim)(desiredLinks)();
