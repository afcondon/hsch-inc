...
var intercalate = function (v) {
    return function (v1) {
        ...
        if (Data_Array.length(v1) === 1) {
            ...
            throw new Error("Failed pattern match at Hylograph.Unified.Display (line 392, column 45 - line 394, column 16): " + [ v2.constructor.name ]);
        };
        ...
        throw new Error("Failed pattern match at Hylograph.Unified.Display (line 395, column 23 - line 397, column 16): " + [ v2.constructor.name ]);
    };
};
...
var insertThousandsSeparators = function (s) {
    ...
    throw new Error("Failed pattern match at Hylograph.Unified.Display (line 366, column 3 - line 371, column 39): " + [ v.constructor.name ]);
};
...
var ensureDecimals = function (n) {
    return function (str) {
        ...
        throw new Error("Failed pattern match at Hylograph.Unified.Display (line 348, column 3 - line 354, column 20): " + [ v.constructor.name ]);
    };
};
...
var dropWhileArray = function ($copy_pred) {
    return function ($copy_arr) {
        ...
        function $tco_loop(pred, arr) {
            ...
            throw new Error("Failed pattern match at Hylograph.Unified.Display (line 421, column 27 - line 426, column 15): " + [ v.constructor.name ]);
        };
        while (!$tco_done) {
