...
import * as Hylograph_Interpreter_SemiQuine_Types from "../Hylograph.Interpreter.SemiQuine.Types/index.js";
...
var templateChoiceToV3Attr = function (attrName) {
    return function (v) {
        if (v instanceof Hylograph_Interpreter_SemiQuine_Types.ConstantNumber) {
            return "evalAttr \"" + (attrName + ("\" (lit " + (show(v.value0) + ")")));
        };
        if (v instanceof Hylograph_Interpreter_SemiQuine_Types.ConstantString) {
            return "evalAttrStr \"" + (attrName + ("\" (str \"" + (v.value0 + "\")")));
        };
        if (v instanceof Hylograph_Interpreter_SemiQuine_Types.FromField) {
        ...
        if (v instanceof Hylograph_Interpreter_SemiQuine_Types.IndexBased) {
            return "fnAttr \"" + (attrName + "\" (\\d -> toNumber d.index)");
        };
        if (v instanceof Hylograph_Interpreter_SemiQuine_Types.Computed) {
        ...
        throw new Error("Failed pattern match at Hylograph.Interpreter.SemiQuine (line 185, column 35 - line 199, column 67): " + [ v.constructor.name ]);
    };
};
...
var choiceToV3Attr = function (attrName) {
    return function (v) {
        ...
        throw new Error("Failed pattern match at Hylograph.Interpreter.SemiQuine (line 166, column 27 - line 181, column 68): " + [ v.constructor.name ]);
    };
};
...
var nodeToCode = function (v) {
    if (v instanceof Hylograph_Interpreter_SemiQuine_Types.BNode) {
        ...
        throw new Error("Failed pattern match at Hylograph.Interpreter.SemiQuine (line 53, column 5 - line 63, column 44): " + [ v.value0.name.constructor.name ]);
    };
    if (v instanceof Hylograph_Interpreter_SemiQuine_Types.BDataJoin) {
        return joinCode(v.value0);
    };
    throw new Error("Failed pattern match at Hylograph.Interpreter.SemiQuine (line 51, column 14 - line 66, column 18): " + [ v.constructor.name ]);
};
...
var childrenCode = function (children) {
    ...
    if (v === 1) {
        ...
        throw new Error("Failed pattern match at Hylograph.Interpreter.SemiQuine (line 100, column 10 - line 104, column 20): " + [ v1.constructor.name ]);
    };
...
var treeToCode = function (tree) {
    return Data_String_Common.joinWith("\x0a")(append([ "-- Generated Tree API code (evalAttr)", "", "import Hylograph.AST as T", "import Hylograph.Internal.Selection.Types (ElementType(..))", "import Hylograph.Expr.Integration (evalAttr, evalAttrStr, fnAttr, fnAttrStr)", "import Hylograph.Expr.Expr (lit, str)", "", "tree :: T.Tree Datum", "tree =" ])(indentLines(2)(nodeToCode(tree))));
};
export {
    treeToCode
};
export {
    ...
    emptyNode
} from "../Hylograph.Interpreter.SemiQuine.Types/index.js";
