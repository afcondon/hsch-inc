...
var toMaybePhaseBehavior = function (v) {
    ...
    throw new Error("Failed pattern match at Hylograph.Unified.Join (line 422, column 1 - line 422, column 97): " + [ v.constructor.name ]);
};
var toTree = function (v) {
    if (v.value0.config.decompose instanceof Data_Maybe.Nothing && v.value0.config.gup instanceof Data_Maybe.Nothing) {
        return Hylograph_AST.joinData(v.value0.config.name)(v.value0.config.key)(v.value0.data_)(v.value0.template);
    };
    if (v.value0.config.decompose instanceof Data_Maybe.Just && v.value0.config.gup instanceof Data_Maybe.Nothing) {
        return Hylograph_AST.nestedJoin(v.value0.config.name)(v.value0.config.key)(v.value0.data_)(v.value0.config.decompose.value0)(v.value0.template);
    };
    if (v.value0.config.decompose instanceof Data_Maybe.Nothing && v.value0.config.gup instanceof Data_Maybe.Just) {
        return Hylograph_AST.updateJoin(v.value0.config.name)(v.value0.config.key)(v.value0.data_)(v.value0.template)({
    ...
    if (v.value0.config.decompose instanceof Data_Maybe.Just && v.value0.config.gup instanceof Data_Maybe.Just) {
        return Hylograph_AST.updateNestedJoin(v.value0.config.name)(v.value0.config.key)(v.value0.data_)(v.value0.config.decompose.value0)(v.value0.template)({
            enter: toMaybePhaseBehavior(v.value0.config.gup.value0.enter),
            update: toMaybePhaseBehavior(v.value0.config.gup.value0.update),
            exit: toMaybePhaseBehavior(v.value0.config.gup.value0.exit)
        });
    };
    throw new Error("Failed pattern match at Hylograph.Unified.Join (line 380, column 3 - line 419, column 11): " + [ v.value0.config.decompose.constructor.name, v.value0.config.gup.constructor.name ]);
};
