...
import * as Hylograph_Kernel_D3_Setup from "../Hylograph.Kernel.D3.Setup/index.js";
import * as Hylograph_Kernel_D3_Simulation from "../Hylograph.Kernel.D3.Simulation/index.js";
...
var tickGroup = function (group) {
    return function __do() {
        ...
        var results = $$for(Data_Array.zipWith(Data_Tuple.Tuple.create)(group.simulations)(activeFlags))(function (v) {
            if (v.value1) {
                return function __do() {
                    var alpha = Hylograph_Kernel_D3_Simulation.tick(v.value0)();
                    return alpha > 0.0;
                };
            };
            return pure(false);
    ...
    return function (active) {
        return function (group) {
            return function __do() {
                ...
                throw new Error("Failed pattern match at Hylograph.Kernel.D3.SimulationGroup (line 223, column 3 - line 225, column 58): " + [ v.constructor.name ]);
            };
        };
    };
};
var setNodesAt = function (idx) {
    return function (nodes) {
        return function (group) {
            ...
            if (v instanceof Data_Maybe.Just) {
                return Hylograph_Kernel_D3_Simulation.setNodes(nodes)(v.value0);
            };
...
var setLinksAt = function (idx) {
    return function (links) {
        return function (group) {
            ...
            if (v instanceof Data_Maybe.Just) {
                return Hylograph_Kernel_D3_Simulation.setLinks(links)(v.value0);
            };
...
var invokeTickCallback = function (group) {
    ...
    throw new Error("Failed pattern match at Hylograph.Kernel.D3.SimulationGroup (line 338, column 28 - line 342, column 13): " + [ group.callbacks.constructor.name ]);
};
var invokeStopCallback = function (group) {
    ...
    throw new Error("Failed pattern match at Hylograph.Kernel.D3.SimulationGroup (line 331, column 28 - line 335, column 13): " + [ group.callbacks.constructor.name ]);
};
...
var invokeStartCallback = function (group) {
    ...
    throw new Error("Failed pattern match at Hylograph.Kernel.D3.SimulationGroup (line 324, column 29 - line 328, column 13): " + [ group.callbacks.constructor.name ]);
};
...
var reheatAt = function (idx) {
    return function (group) {
        ...
        throw new Error("Failed pattern match at Hylograph.Kernel.D3.SimulationGroup (line 208, column 22 - line 213, column 38): " + [ v.constructor.name ]);
    };
};
...
var getNodesAt = function (idx) {
    return function (group) {
        ...
        if (v instanceof Data_Maybe.Just) {
            return map(Data_Maybe.Just.create)(Hylograph_Kernel_D3_Simulation.getNodes(v.value0));
        };
...
var defaultGroupConfig = {
    count: 1,
    simConfig: Hylograph_Kernel_D3_Simulation.defaultConfig
};
        ...
        return function (cbs) {
            return function __do() {
                var sims = $$for(Data_Array.range(0)(count - 1 | 0))(function (v) {
                    return Hylograph_Kernel_D3_Simulation.create(config);
                })();
...
var applySetupAt = function (idx) {
    return function (setup) {
        return function (group) {
            ...
            if (v instanceof Data_Maybe.Just) {
                return Hylograph_Kernel_D3_Setup.applySetup(setup)(v.value0);
            };
            throw new Error("Failed pattern match at Hylograph.Kernel.D3.SimulationGroup (line 297, column 32 - line 299, column 41): " + [ v.constructor.name ]);
        };
    };
};
var applySetupAll = function (setup) {
    return function (group) {
        return for_(group.simulations)(function (sim) {
            return Hylograph_Kernel_D3_Setup.applySetup(setup)(sim);
        });
    };
};
export {
