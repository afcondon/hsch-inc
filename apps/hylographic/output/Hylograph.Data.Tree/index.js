...
var showTreeType = {
    show: function (v) {
        ...
        throw new Error("Failed pattern match at Hylograph.Data.Tree (line 37, column 1 - line 39, column 33): " + [ v.constructor.name ]);
    }
};
var makeD3TreeJSONFromTreeID = function (root) {
    return function (nodesMap) {
        var go = function (tree) {
            ...
            throw new Error("Failed pattern match at Hylograph.Data.Tree (line 73, column 10 - line 77, column 68): " + [ v.constructor.name ]);
        };
        return go(root);
    };
};
...
var arrayToTree = function (config) {
    ...
    throw new Error("Failed pattern match at Hylograph.Data.Tree (line 134, column 3 - line 139, column 43): " + [ v.constructor.name ]);
};
export {
    TidyTree,
    Dendrogram,
