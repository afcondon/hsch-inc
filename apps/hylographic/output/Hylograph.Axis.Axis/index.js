...
import * as Hylograph_Expr_Integration from "../Hylograph.Expr.Integration/index.js";
...
var str = /* #__PURE__ */ Hylograph_Expr_Expr.str(Hylograph_Expr_Interpreter_Eval.stringExprEvalD);
var evalAttr = /* #__PURE__ */ Hylograph_Expr_Integration.evalAttr(Data_Show.showNumber);
var lit = /* #__PURE__ */ Hylograph_Expr_Expr.lit(Hylograph_Expr_Interpreter_Eval.numExprEvalD);
...
var renderAxis = function (ax) {
    ...
    var tickElements = map(function (tickValue) {
        ...
        return Hylograph_AST.withChildren(Hylograph_AST.elem(Hylograph_Internal_Selection_Types.Group.value)([ Hylograph_Expr_Integration.evalAttrStr("class")(str("tick")), Hylograph_Expr_Integration.evalAttrStr("transform")(str(v.tickTransform(pos))) ]))([ Hylograph_AST.elem(Hylograph_Internal_Selection_Types.Line.value)([ evalAttr("x1")(lit(v.tickLine.x1)), evalAttr("y1")(lit(v.tickLine.y1)), evalAttr("x2")(lit(v.tickLine.x2)), evalAttr("y2")(lit(v.tickLine.y2)), Hylograph_Expr_Integration.evalAttrStr("stroke")(str("currentColor")) ]), Hylograph_AST.elem(Hylograph_Internal_Selection_Types.Text.value)([ evalAttr("x")(lit(v.tickText.x)), evalAttr("y")(lit(v.tickText.y)), Hylograph_Expr_Integration.evalAttrStr("text-anchor")(str(v.tickText.anchor)), evalAttr("dy")(lit(v.tickText.dyVal)), Hylograph_Expr_Integration.evalAttrStr("fill")(str("currentColor")), evalAttr("font-size")(lit(10.0)), Hylograph_Expr_Integration.evalAttrStr("textContent")(str(formatter(tickValue))) ]) ]);
    })(ticks);
    return Hylograph_AST.withChildren(Hylograph_AST.elem(Hylograph_Internal_Selection_Types.Group.value)([ Hylograph_Expr_Integration.evalAttrStr("class")(str("axis")), Hylograph_Expr_Integration.evalAttrStr("fill")(str("none")), evalAttr("font-size")(lit(10.0)), Hylograph_Expr_Integration.evalAttrStr("stroke")(str("currentColor")) ]))(append1([ Hylograph_AST.elem(Hylograph_Internal_Selection_Types.Path.value)([ Hylograph_Expr_Integration.evalAttrStr("class")(str("domain")), Hylograph_Expr_Integration.evalAttrStr("stroke")(str("currentColor")), Hylograph_Expr_Integration.evalAttrStr("d")(str(v.domainPath)) ]) ])(tickElements));
};
export {
    Top,
    Right,
