...
var treeDSLTree = {
    ...
    withChild: function (parent) {
        return function (child) {
            ...
            throw new Error("Failed pattern match at Hylograph.AST (line 597, column 28 - line 604, column 47): " + [ parent.constructor.name ]);
        };
    },
    withChildren: function (parent) {
        return function (newChildren) {
            ...
            throw new Error("Failed pattern match at Hylograph.AST (line 606, column 37 - line 613, column 47): " + [ parent.constructor.name ]);
        };
    },
    withBehaviors: function (tree) {
        return function (newBehaviors) {
            ...
            throw new Error("Failed pattern match at Hylograph.AST (line 615, column 37 - line 622, column 47): " + [ tree.constructor.name ]);
        };
    },
...
var withChildren = function (parent) {
    return function (newChildren) {
        ...
        throw new Error("Failed pattern match at Hylograph.AST (line 299, column 35 - line 306, column 45): " + [ parent.constructor.name ]);
    };
};
var withChild = function (parent) {
    return function (child) {
        ...
        throw new Error("Failed pattern match at Hylograph.AST (line 286, column 26 - line 293, column 45): " + [ parent.constructor.name ]);
    };
};
var withBehaviors = function (tree) {
    return function (newBehaviors) {
        ...
        throw new Error("Failed pattern match at Hylograph.AST (line 326, column 35 - line 333, column 45): " + [ tree.constructor.name ]);
    };
};
...
export {
    ...
    Thead,
    Tr
} from "../Hylograph.Internal.Selection.Types/index.js";
