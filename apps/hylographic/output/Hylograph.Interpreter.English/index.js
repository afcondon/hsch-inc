...
var showElemType = function (v) {
    ...
    throw new Error("Failed pattern match at Hylograph.Interpreter.English (line 124, column 1 - line 124, column 38): " + [ v.constructor.name ]);
};
var showAttrValue = function (v) {
    ...
    throw new Error("Failed pattern match at Hylograph.Interpreter.English (line 151, column 1 - line 151, column 42): " + [ v.constructor.name ]);
};
...
var describeSource = function (v) {
    ...
    throw new Error("Failed pattern match at Hylograph.Interpreter.English (line 115, column 18 - line 121, column 53): " + [ v.constructor.name ]);
};
var describeAttribute = function (v) {
    ...
    throw new Error("Failed pattern match at Hylograph.Interpreter.English (line 97, column 1 - line 97, column 61): " + [ v.constructor.name ]);
};
    ...
    return function (level) {
        if (tree instanceof Hylograph_AST.Node) {
            return discard((function () {
                ...
                throw new Error("Failed pattern match at Hylograph.Interpreter.English (line 33, column 5 - line 35, column 77): " + [ tree.value0.name.constructor.name ]);
            })())(function () {
        ...
        throw new Error("Failed pattern match at Hylograph.Interpreter.English (line 31, column 27 - line 94, column 35): " + [ tree.constructor.name ]);
    };
};
