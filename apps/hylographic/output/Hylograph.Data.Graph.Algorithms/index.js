...
import * as Hylograph_Data_Graph from "../Hylograph.Data.Graph/index.js";
            ...
            var processNextPath = function (state) {
                return bind(Data_Array.uncons(state.openPaths))(function (x) {
                    return bind(Data_Array.head(x.head))(function (currentId) {
                        var links = Hylograph_Data_Graph.getLinksFrom(currentId)(graph);
            ...
            var go = function ($copy_state) {
                ...
                function $tco_loop(state) {
                    ...
                    if (Data_Boolean.otherwise) {
                        ...
                        throw new Error("Failed pattern match at Hylograph.Data.Graph.Algorithms (line 68, column 21 - line 70, column 35): " + [ v.constructor.name ]);
                    };
                    throw new Error("Failed pattern match at Hylograph.Data.Graph.Algorithms (line 66, column 5 - line 70, column 35): " + [ state.constructor.name ]);
                };
                while (!$tco_done) {
                ...
                var find = function ($copy_v) {
                    return function ($copy_v1) {
                        ...
                        function $tco_loop(v, v1) {
                            ...
                            throw new Error("Failed pattern match at Hylograph.Data.Graph.Algorithms (line 162, column 21 - line 165, column 48): " + [ v2.constructor.name ]);
                        };
                        while (!$tco_done) {
                                    ...
                                    if (Data_Boolean.otherwise) {
                                        ...
                                        if (v1 instanceof Data_Maybe.Just) {
                                            ...
                                            if ($48) {
                                                ...
                                                var links = Hylograph_Data_Graph.getLinksFrom(v.value0.head)(graph);
                                        ...
                                        throw new Error("Failed pattern match at Hylograph.Data.Graph.Algorithms (line 140, column 24 - line 154, column 41): " + [ v1.constructor.name ]);
                                    };
                                };
                                throw new Error("Failed pattern match at Hylograph.Data.Graph.Algorithms (line 136, column 31 - line 154, column 41): " + [ v.constructor.name ]);
                            };
                            while (!$tco_done1) {
                ...
                var find = function ($copy_v) {
                    return function ($copy_v1) {
                        ...
                        function $tco_loop(v, v1) {
                            ...
                            throw new Error("Failed pattern match at Hylograph.Data.Graph.Algorithms (line 208, column 21 - line 211, column 48): " + [ v2.constructor.name ]);
                        };
                        while (!$tco_done) {
                            $tco_result = $tco_loop($tco_var_v, $copy_v1);
                        };
                            ...
                            function $tco_loop(queue, visited, result) {
                                ...
                                if (v instanceof Data_Maybe.Just) {
                                    ...
                                    if (Data_Boolean.otherwise) {
                                        ...
                                        throw new Error("Failed pattern match at Hylograph.Data.Graph.Algorithms (line 186, column 24 - line 200, column 41): " + [ v1.constructor.name ]);
                                    };
                                };
                                throw new Error("Failed pattern match at Hylograph.Data.Graph.Algorithms (line 182, column 31 - line 200, column 41): " + [ v.constructor.name ]);
                            };
                            while (!$tco_done1) {
