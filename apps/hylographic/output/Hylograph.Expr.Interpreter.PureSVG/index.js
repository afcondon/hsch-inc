...
var render = function (v) {
    ...
    throw new Error("Failed pattern match at Hylograph.Expr.Interpreter.PureSVG (line 159, column 10 - line 169, column 76): " + [ v.constructor.name ]);
};
var renderDoc = function (doc) {
    var viewBoxAttr = (function () {
        ...
        throw new Error("Failed pattern match at Hylograph.Expr.Interpreter.PureSVG (line 175, column 19 - line 177, column 20): " + [ doc.viewBox.constructor.name ]);
    })();
    var childStr = foldl(function (acc) {
        return function (child) {
