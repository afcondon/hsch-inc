...
var updateNodePosition = function (positions) {
    return function (node) {
        ...
        throw new Error("Failed pattern match at Hylograph.Kernel.D3.Adapter (line 116, column 3 - line 118, column 20): " + [ v.constructor.name ]);
    };
};
...
var applyFirstMatchingRule = function (rules) {
    return function (node) {
        ...
        throw new Error("Failed pattern match at Hylograph.Kernel.D3.Adapter (line 138, column 3 - line 140, column 20): " + [ v.constructor.name ]);
    };
};
