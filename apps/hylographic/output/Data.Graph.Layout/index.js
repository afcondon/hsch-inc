    ...
    return function (config) {
        return function (nodes) {
            var layerGroups = foldl(function (acc) {
                return function (n) {
                    return alter((function () {
                        var $135 = Data_Array.cons(n.id);
                        var $136 = Data_Maybe.fromMaybe([  ]);
                        return function ($137) {
                            return Data_Maybe.Just.create($135($136($137)));
                        };
                    })())(n.layer)(acc);
                };
            ...
            return mapFlipped(nodes)(function (n) {
                ...
                throw new Error("Failed pattern match at Data.Graph.Layout (line 187, column 7 - line 189, column 71): " + [ v.constructor.name ]);
            });
        };
    };
};
        ...
        return function (layers) {
            return foldl(function (acc) {
                return function (node) {
                    ...
                    return alter((function () {
                        var $138 = Data_Array.cons(node);
                        var $139 = Data_Maybe.fromMaybe([  ]);
                        return function ($140) {
                            return Data_Maybe.Just.create($138($139($140)));
                        };
                    })())(layer)(acc);
                };
            })(Data_Map_Internal.empty)(nodes);
                ...
                return foldl(function (a) {
                    return function (target) {
                        return alter1((function () {
                            var $141 = insert1(v.value0);
                            var $142 = Data_Maybe.fromMaybe(Data_Set.empty);
                            return function ($143) {
                                return Data_Maybe.Just.create($141($142($143)));
                            };
                        })())(target)(a);
                    };
...
var assignCoordinates = function (dictOrd) {
    ...
    return function (config) {
        return function (layerGroups) {
            var maxLayer = Data_Maybe.fromMaybe(0)(maximum(Data_Map.keys(layerGroups)));
            return foldl(function (acc) {
                return function (v) {
                    ...
                    var layerPos = toNumber(effectiveLayer) * config.nodeHeight;
                    var count = Data_Array.length(v.value1);
                    var startCross = -((toNumber(count - 1 | 0) * config.nodeWidth) / 2.0);
                    return foldl(function (a) {
                        return function (v1) {
                            var crossPos = startCross + toNumber(v1.value0) * config.nodeWidth;
                            var pos = (function () {
                                if (config.orientation instanceof Vertical) {
                                    return {
                                        x: crossPos,
                            ...
                            return insert1(v1.value1)(pos)(a);
                        };
                    })(acc)(Data_Array.mapWithIndex(function (i) {
                        return function (n) {
                            return new Data_Tuple.Tuple(i, n);
