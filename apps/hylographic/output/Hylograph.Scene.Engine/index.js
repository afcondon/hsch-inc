...
var transitionTo = function (targetScene) {
    return function (engineRef) {
        return function __do() {
            ...
            throw new Error("Failed pattern match at Hylograph.Scene.Engine (line 182, column 3 - line 209, column 27): " + [ state.transition.constructor.name ]);
        };
    };
};
...
var defaultTransitionDelta = /* #__PURE__ */ Hylograph_Transition_Tick.ticksForDuration(2000);
    ...
    return function (engineRef) {
        return function (state) {
            return function __do() {
                ...
                (function () {
                    if (t.targetScene.stableMode instanceof Hylograph_Scene_Types.Physics) {
                        return state.adapter.reheat();
                    };
                    if (t.targetScene.stableMode instanceof Hylograph_Scene_Types.Static) {
                        return Data_Unit.unit;
                    };
                    throw new Error("Failed pattern match at Hylograph.Scene.Engine (line 280, column 3 - line 282, column 30): " + [ t.targetScene.stableMode.constructor.name ]);
                })();
...
var runInterpolationEngine = function (t) {
    return function (engineRef) {
        return function (state) {
            ...
            var easedProgress = Hylograph_Transition_Tick.easeInOutCubic(newProgress);
            return function __do() {
...
var tick = function (engineRef) {
    return function __do() {
        ...
        throw new Error("Failed pattern match at Hylograph.Scene.Engine (line 223, column 3 - line 230, column 17): " + [ state.transition.constructor.name ]);
    };
};
export {
    createEngine,
