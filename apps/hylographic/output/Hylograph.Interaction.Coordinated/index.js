...
var showInteractionTrigger = {
    show: function (v) {
        ...
        throw new Error("Failed pattern match at Hylograph.Interaction.Coordinated (line 116, column 1 - line 121, column 37): " + [ v.constructor.name ]);
    }
};
var showInteractionState = {
    show: function (v) {
        ...
        throw new Error("Failed pattern match at Hylograph.Interaction.Coordinated (line 145, column 1 - line 150, column 27): " + [ v.constructor.name ]);
    }
};
...
var ordInteractionState = {
    compare: function (x) {
        return function (y) {
            ...
            throw new Error("Failed pattern match at Hylograph.Interaction.Coordinated (line 0, column 0 - line 0, column 0): " + [ x.constructor.name, y.constructor.name ]);
        };
    },
    Eq0: function () {
...
var stateToInt = function (v) {
    ...
    throw new Error("Failed pattern match at Hylograph.Interaction.Coordinated (line 258, column 1 - line 258, column 38): " + [ v.constructor.name ]);
};
