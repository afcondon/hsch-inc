                ...
                return function (onComplete) {
                    return function __do() {
                        ...
                        var v1 = (function () {
                            ...
                            throw new Error("Failed pattern match at Hylograph.Internal.Transition.Manager (line 194, column 31 - line 199, column 96): " + [ v1.constructor.name ]);
                        })();
                        var key = {
                            elementId: v1.value0,
                            attrName: attrName
...
var evalAnimatedValue = function (v) {
    return function (v1) {
        return function (v2) {
            if (v instanceof Hylograph_Internal_Attribute.StaticAnimValue) {
                return v.value0;
            };
            if (v instanceof Hylograph_Internal_Attribute.DataAnimValue) {
                return v.value0(v1);
            };
            if (v instanceof Hylograph_Internal_Attribute.IndexedAnimValue) {
                return v.value0(v1)(v2);
            };
            throw new Error("Failed pattern match at Hylograph.Internal.Transition.Manager (line 296, column 1 - line 296, column 81): " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
        };
    };
};
                                ...
                                return function (onComplete) {
                                    ...
                                    return function __do() {
                                        var from = (function () {
                                            ...
                                            throw new Error("Failed pattern match at Hylograph.Internal.Transition.Manager (line 245, column 11 - line 247, column 52): " + [ maybeFrom.constructor.name ]);
                                        })();
                                        var spec = {
                                            from: from,
                                            to: to,
...
var applyEasing = function (v) {
    return function (v1) {
        if (v instanceof Hylograph_Internal_Attribute.Linear) {
            return v1;
        };
        if (v instanceof Hylograph_Internal_Attribute.QuadIn) {
            return v1 * v1;
        };
        if (v instanceof Hylograph_Internal_Attribute.QuadOut) {
            return v1 * (2.0 - v1);
        };
        if (v instanceof Hylograph_Internal_Attribute.QuadInOut) {
            var $102 = v1 < 0.5;
            if ($102) {
                return 2.0 * v1 * v1;
            };
        ...
        if (v instanceof Hylograph_Internal_Attribute.CubicIn) {
            return v1 * v1 * v1;
        };
        if (v instanceof Hylograph_Internal_Attribute.CubicOut) {
            var t$prime = v1 - 1.0;
            return t$prime * t$prime * t$prime + 1.0;
        };
        if (v instanceof Hylograph_Internal_Attribute.CubicInOut) {
            var $103 = v1 < 0.5;
            if ($103) {
                return 4.0 * v1 * v1 * v1;
            };
        ...
        if (v instanceof Hylograph_Internal_Attribute.SinIn) {
            return 1.0 - $foreign.cos((v1 * pi) / 2.0);
        };
        if (v instanceof Hylograph_Internal_Attribute.SinOut) {
            return $foreign.sin((v1 * pi) / 2.0);
        };
        if (v instanceof Hylograph_Internal_Attribute.SinInOut) {
            return -($foreign.cos(pi * v1) - 1.0) / 2.0;
        };
        if (v instanceof Hylograph_Internal_Attribute.ExpIn) {
            var $104 = v1 === 0.0;
            if ($104) {
                return 0.0;
            };
        ...
        if (v instanceof Hylograph_Internal_Attribute.ExpOut) {
            var $105 = v1 === 1.0;
            if ($105) {
                return 1.0;
            };
        ...
        if (v instanceof Hylograph_Internal_Attribute.ExpInOut) {
            var $106 = v1 === 0.0;
            if ($106) {
                return 0.0;
            };
        ...
        if (v instanceof Hylograph_Internal_Attribute.CircleIn) {
            return 1.0 - $foreign.sqrt(1.0 - v1 * v1);
        };
        if (v instanceof Hylograph_Internal_Attribute.CircleOut) {
            return $foreign.sqrt(1.0 - $foreign.pow(v1 - 1.0)(2.0));
        };
        if (v instanceof Hylograph_Internal_Attribute.CircleInOut) {
            var $109 = v1 < 0.5;
            if ($109) {
        ...
        if (v instanceof Hylograph_Internal_Attribute.BackIn) {
            var c3 = 1.70158 + 1.0;
            return c3 * v1 * v1 * v1 - 1.70158 * v1 * v1;
        };
        if (v instanceof Hylograph_Internal_Attribute.BackOut) {
            var t$prime = v1 - 1.0;
            var c3 = 1.70158 + 1.0;
            return 1.0 + c3 * t$prime * t$prime * t$prime + 1.70158 * t$prime * t$prime;
        };
        if (v instanceof Hylograph_Internal_Attribute.BackInOut) {
        ...
        if (v instanceof Hylograph_Internal_Attribute.ElasticIn) {
            var $111 = v1 === 0.0;
            if ($111) {
                return 0.0;
            };
        ...
        if (v instanceof Hylograph_Internal_Attribute.ElasticOut) {
            var $113 = v1 === 0.0;
            if ($113) {
                return 0.0;
            };
        ...
        if (v instanceof Hylograph_Internal_Attribute.ElasticInOut) {
            var $115 = v1 === 0.0;
            if ($115) {
                return 0.0;
            };
        ...
        if (v instanceof Hylograph_Internal_Attribute.BounceIn) {
            return 1.0 - bounceOut(1.0 - v1);
        };
        if (v instanceof Hylograph_Internal_Attribute.BounceOut) {
            return bounceOut(v1);
        };
        if (v instanceof Hylograph_Internal_Attribute.BounceInOut) {
            var $118 = v1 < 0.5;
            if ($118) {
        ...
        throw new Error("Failed pattern match at Hylograph.Internal.Transition.Manager (line 395, column 1 - line 395, column 46): " + [ v.constructor.name, v1.constructor.name ]);
    };
};
var tick = function (v) {
        ...
        return function __do() {
            ...
            for_(transitions)(function (v1) {
                ...
                var v2 = (function () {
                    ...
                    throw new Error("Failed pattern match at Hylograph.Internal.Transition.Manager (line 322, column 39 - line 324, column 105): " + [ v1.value1.transitionType.constructor.name ]);
                })();
                ...
                return function __do() {
                    (function () {
                        ...
                        throw new Error("Failed pattern match at Hylograph.Internal.Transition.Manager (line 337, column 5 - line 350, column 65): " + [ v1.value1.transitionType.constructor.name ]);
                    })();
