...
(() => {
  ...
  var heroViz = /* @__PURE__ */ screenshotLink("demo.jpeg")("/honeycomb/")("Honeycomb Puzzle Demo");
  var heroText = [/* @__PURE__ */ p_([/* @__PURE__ */ text5("This package provides graph algorithms with optional tracing for visualization, consolidating graph-related code from the PSD3 ecosystem.")])];
  var config = {
    name: "psd3-graph",
    title: "Graph",
  ...
  var codeSnippet = "import Data.Graph.Pathfinding (findPath)\n\nresult = findPath startNode endNode myGraph";
  var render = function(v) {
    return shell(config)([heroWithViz(config)(heroText)(heroViz), elaboration([{
      heading: "Graph Algorithms",
      content: [para("Pathfinding: A*, Dijkstra, BFS/DFS"), para("Analysis: Reachability, transitive reduction, layer computation"), para("DAG operations: Topological sort, cycle detection")]
    }, {
      heading: "Tree Utilities",
      content: [para("Rose tree helpers (wrapping tree-rose)"), para("Tree manipulation functions"), para('DAGTree for "mostly hierarchical" graphs')]
    }, {
      heading: "Visualization Support",
      content: [para("Optional algorithm tracing for step-by-step animation"), para("Position helpers for layout")]
