...
(() => {
  ...
  var heroViz = /* @__PURE__ */ screenshotLink("hylograph-explorer.jpg")("demo/")("Hylograph: Interactive HATS Explorer");
  var heroText = [/* @__PURE__ */ p_([/* @__PURE__ */ text5("A declarative, type-safe approach to D3.js visualization in PureScript. Instead of imperative D3 method chaining, you build a tree AST that describes your visualization, then interpret it to render.")])];
  var config = {
  ...
  var codeSnippet = 'myViz :: T.Tree Unit\nmyViz =\n  T.named SVG "chart"\n    [ attr "width" $ num 400.0\n    , attr "height" $ num 300.0\n    ]\n    `T.withChild`\n      T.elem Circle\n        [ cx $ num 200.0\n        , cy $ num 150.0\n        , r $ num 50.0\n        , fill $ text "steelblue"\n        ]';
  var render = function(v) {
    return shell(config)([heroWithViz(config)(heroText)(heroViz), elaboration([{
      heading: "Tree AST",
      content: [para("Build visualizations as data structures:")]
    }, {
      heading: "Data Joins",
      content: [para("D3-style enter/update/exit with type safety:")]
    }, {
      heading: "Interpreters",
      content: [para("D3 Interpreter - Renders to DOM via D3.js"), para("English Interpreter - Describes the tree in plain English"), para("Mermaid Interpreter - Generates Mermaid diagrams")]
