...
(() => {
  ...
  var fromFoldable = function(dictOrd) {
    ...
    return function(dictFoldable) {
      return foldl(dictFoldable)(function(m2) {
        return function(v) {
          return insert1(v.value0)(v.value1)(m2);
        };
      })(empty2);
    };
  };
  ...
  var renderMethod = function(_ctx0) {
    return function(typeParams) {
      return function(m2) {
        if (m2.ast instanceof Just) {
          var peeled = peelSignature(m2.ast.value0);
          var methodVars = append12(typeParams)(append12(collectForallVars(m2.ast.value0))(toUnfoldable3(collectTypeVars(m2.ast.value0))));
          ...
          return '<div class="sig-method">' + ((function() {
            ...
            ;
            return "";
          })() + ('<div class="sig-method-decl">' + ('<dfn class="sig-method-name">' + (escapeHtml(m2.name) + ("</dfn>" + ('<small class="sig-method-sep"> :: </small>' + (renderTypeTree(ctx)(peeled.body) + ("</div>" + ((function() {
            if (hasForall) {
        ...
        ;
        if (m2.ast instanceof Nothing) {
          return '<div class="sig-method">' + ('<div class="sig-method-decl">' + ('<dfn class="sig-method-name">' + (escapeHtml(m2.name) + "</dfn></div></div>")));
        }
        ;
        throw new Error("Failed pattern match at Sigil.Html (line 922, column 35 - line 957, column 16): " + [m2.ast.constructor.name]);
      };
    };
  };
        ...
        return function(s) {
          ...
          if (m2 == null || m2.length === 0) {
            ...
            for (var i = 0; i < m2.length; i++) {
              m2[i] = m2[i] == null ? nothing : just(m2[i]);
            }
            return just(m2);
          }
        };
  ...
  var renderSig = function(sel) {
    return function(name) {
      return function(sig) {
        ...
        ;
        if (v instanceof Nothing) {
          return log("[Ecosystem] Parse failed: " + name);
        }
        ;
        throw new Error("Failed pattern match at Main (line 76, column 3 - line 78, column 58): " + [v.constructor.name]);
      };
    };
  };
  var renderClass = function(sel) {
    return function(name) {
      return function(typeParams) {
        return function(methods) {
          return renderClassDeclInto(sel)({
            name,
            typeParams,
            superclasses: [],
            methods
  ...
  var renders = [/* @__PURE__ */ renderSig("#sigil-hero-bind")("bind")("m a -> (a -> m b) -> m b"), /* @__PURE__ */ renderClass("#sigil-class-functor")("Functor")(["f"])([/* @__PURE__ */ m("map")("(a -> b) -> f a -> f b")]), /* @__PURE__ */ renderClass("#sigil-class-apply")("Apply")(["f"])([/* @__PURE__ */ m("apply")("f (a -> b) -> f a -> f b")]), /* @__PURE__ */ renderClass("#sigil-class-applicative")("Applicative")(["f"])([/* @__PURE__ */ m("pure")("a -> f a")]), /* @__PURE__ */ renderClass("#sigil-class-bind")("Bind")(["m"])([/* @__PURE__ */ m("bind")("m a -> (a -> m b) -> m b")]), /* @__PURE__ */ renderClass("#sigil-class-monad")("Monad")(["m"])([]), /* @__PURE__ */ renderClass("#sigil-class-semiring")("Semiring")(["a"])([/* @__PURE__ */ m("add")("a -> a -> a"), /* @__PURE__ */ m("mul")("a -> a -> a"), /* @__PURE__ */ mn("zero"), /* @__PURE__ */ mn("one")]), /* @__PURE__ */ renderClass("#sigil-class-ring")("Ring")(["a"])([/* @__PURE__ */ m("sub")("a -> a -> a")]), /* @__PURE__ */ renderClass("#sigil-class-euclideanring")("EuclideanRing")(["a"])([/* @__PURE__ */ m("div")("a -> a -> a"), /* @__PURE__ */ m("mod")("a -> a -> a")]), /* @__PURE__ */ renderClass("#sigil-class-eq")("Eq")(["a"])([/* @__PURE__ */ m("eq")("a -> a -> Boolean")]), /* @__PURE__ */ renderClass("#sigil-class-ord")("Ord")(["a"])([/* @__PURE__ */ m("compare")("a -> a -> Ordering")]), /* @__PURE__ */ renderClass("#sigil-class-semigroup")("Semigroup")(["a"])([/* @__PURE__ */ m("append")("a -> a -> a")]), /* @__PURE__ */ renderClass("#sigil-class-monoid")("Monoid")(["a"])([/* @__PURE__ */ mn("mempty")]), /* @__PURE__ */ renderClass("#sigil-class-foldable")("Foldable")(["f"])([/* @__PURE__ */ m("foldr")("(a -> b -> b) -> b -> f a -> b"), /* @__PURE__ */ m("foldl")("(b -> a -> b) -> b -> f a -> b"), /* @__PURE__ */ m("foldMap")("(a -> m) -> f a -> m")]), /* @__PURE__ */ renderClass("#sigil-class-traversable")("Traversable")(["t"])([/* @__PURE__ */ m("traverse")("(a -> m b) -> t a -> m (t b)"), /* @__PURE__ */ m("sequence")("t (m a) -> m (t a)")])];
