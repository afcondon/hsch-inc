...
(() => {
  ...
  var heroViz = /* @__PURE__ */ screenshotLink("demo.jpeg")("/layouts/")("Layout Gallery Demo");
  var heroText = [/* @__PURE__ */ p_([/* @__PURE__ */ text5("Layout algorithms for hierarchical and graph data, implemented in pure PureScript. Many of these layouts are familiar to users of D3 but here they are implemented without FFI dependencies using FP implementations in 100% PureScript. These work with the rose-tree data structure from purescript-tree-rose.")])];
  var config = {
    name: "psd3-layout",
    title: "Layout",
  ...
  var codeSnippet = 'import DataViz.Layout.Hierarchy.Tree (tree, defaultTreeConfig)\nimport Data.Tree (mkTree)\n\nmyTree = mkTree "root" [mkTree "a" [], mkTree "b" []]\nconfig = defaultTreeConfig { size = { width: 400.0, height: 300.0 } }\npositioned = tree config myTree\n-- Each node now has x, y coordinates';
  var render = function(v) {
    return shell(config)([heroWithViz(config)(heroText)(heroViz), elaboration([{
      heading: "Hierarchical Layouts",
      content: [para("Tree - Tidy tree layout (Reingold-Tilford algorithm)"), para("Pack - Circle packing for hierarchical data"), para("Partition - Sunburst/icicle partition layout"), para("Treemap - Multiple tiling algorithms: squarify (default), slice, dice, sliceDice, binary")]
    }, {
      heading: "Graph Layouts",
      content: [para("Sankey - Flow diagram layout for directed acyclic graphs"), para("EdgeBundle - Hierarchical edge bundling")]
