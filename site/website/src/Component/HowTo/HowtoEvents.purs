    ...
    , HH.main_
        ...
        , HH.section
            ...
            , HH.pre
                ...
                [ HH.code_
                    [ HH.text """import Hylograph.Internal.Behavior.Types (onClickWithDatum)
...
_ <- on (onClickWithDatum \\d -> log ("Clicked: " <> d.name)) circles""" ]
            ...
            , HH.pre
                [ HP.classes [ HH.ClassName "code-block" ] ]
                [ HH.code_
                    [ HH.text """import Hylograph.Internal.Behavior.Types (onClick)
...
_ <- on (onClick (log "Button clicked!")) button""" ]
        ...
        , HH.section
            ...
            , HH.pre
                [ HP.classes [ HH.ClassName "code-block" ] ]
                [ HH.code_
                    [ HH.text """import Hylograph.Internal.Behavior.Types (onMouseEnter, onMouseLeave)
...
_ <- on (onMouseLeave \\_ -> clearHighlight) circles""" ]
            ...
            , HH.pre
                [ HP.classes [ HH.ClassName "code-block" ] ]
                [ HH.code_
                    [ HH.text """import Hylograph.Internal.Behavior.Types (onHover)
...
_ <- on (onHover
  ...
  , leave: [{ attr: "stroke", value: "#ddd" }, { attr: "stroke-width", value: "1.5" }]
            ...
            , HH.pre
                [ HP.classes [ HH.ClassName "code-block" ] ]
                [ HH.code_
                    [ HH.text """import Hylograph.Internal.Behavior.Types (onMouseEnterWithInfo)
  ...
  showTooltip info.datum info.pageX info.pageY
        ...
        , HH.section
            ...
            , HH.pre
                [ HP.classes [ HH.ClassName "code-block" ] ]
                [ HH.code_
                    [ HH.text """import Hylograph.Internal.Behavior.Types (Drag(..), defaultDrag)
...
_ <- on (Drag defaultDrag) draggableElement""" ]
            ...
            , HH.pre
                [ HP.classes [ HH.ClassName "code-block" ] ]
                [ HH.code_
                    [ HH.text """import Hylograph.Internal.Behavior.Types (Drag(..), simulationDrag)
...
_ <- on (Drag (simulationDrag "my-simulation-id")) nodes""" ]
            ...
            , HH.pre
                [ HP.classes [ HH.ClassName "code-block" ] ]
                [ HH.code_
                    [ HH.text """import Hylograph.Internal.Behavior.Types (Zoom(..), defaultZoom, ScaleExtent(..))
