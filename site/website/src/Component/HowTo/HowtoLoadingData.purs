    ...
    , HH.main_
        ...
        , HH.section
            ...
            , HH.pre
                ...
                [ HH.code_
                    [ HH.text """import Hylograph.Shared.DataLoader (simpleLoadJSON)
...
-- Returns fallback on error, never throws""" ]
            ...
            , HH.pre
                [ HP.classes [ HH.ClassName "code-block" ] ]
                [ HH.code_
                    [ HH.text """import Hylograph.Shared.DataLoader (loadJSON, defaultConfig, LoadError(..))
  ...
  Right json -> processData json""" ]
        ...
        , HH.section
            ...
            , HH.pre
                [ HP.classes [ HH.ClassName "code-block" ] ]
                [ HH.code_
                    [ HH.text """import Hylograph.Shared.DataLoader (loadJSON, LoadStrategy(..), LoadConfig)
...
json <- H.liftAff $ loadJSON hybridConfig "data/graph.json\"""" ]
        ...
        , HH.section
            ...
            , HH.pre
                [ HP.classes [ HH.ClassName "code-block" ] ]
                [ HH.code_
                    [ HH.text """import Hylograph.Shared.DataLoader (simpleLoadCSV, loadCSV)
