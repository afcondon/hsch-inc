    ...
    , HH.main_
        ...
        , HH.section
            ...
            , HH.pre
                ...
                [ HH.code_
                    [ HH.text """import Hylograph.Tooltip (onTooltip, onTooltipHide)
...
_ <- on onTooltipHide circles""" ]
  ...
  font-family: monospace;
            ...
            , HH.pre
                [ HP.classes [ HH.ClassName "code-block" ] ]
                [ HH.code_
                    [ HH.text """import Hylograph.Tooltip (setTooltipClass)
...
liftEffect $ setTooltipClass "my-custom-tooltip\"""" ]
        ...
        , HH.section
            ...
            , HH.pre
                [ HP.classes [ HH.ClassName "code-block" ] ]
                [ HH.code_
                    [ HH.text """import Hylograph.Tooltip (onTooltip, hideTooltip)
