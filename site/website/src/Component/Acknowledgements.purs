module Hylograph.Acknowledgements where
    ...
    , HH.div
        ...
        , HH.section
            ...
            , HH.p_
                ...
                , HH.text ". D3 revolutionized web-based data visualization and established patterns that have become fundamental to the field. Many of the examples in Hylograph are adapted from Mike's extensive collection of examples and tutorials."
                ]
            , HH.p_
        ...
        , HH.section
            ...
            , HH.p_
                [ HH.text "Several chart examples are based on visualizations from "
            ...
            , HH.p_
                [ HH.text "These examples have been reimplemented in PureScript to demonstrate the library's capabilities while faithfully reproducing the original visualizations' dimensions, scales, and styling."
                ]
            ]
        ...
        , HH.section
            ...
            , HH.p_
                [ HH.text "Ian Ross, for his solution to the polymorphic attribute architecture with typeclasses."
                ]
            , HH.p_
                [ HH.text "The PureScript Core Team and the wider PureScript community for building this language and ecosystem."
                ]
            ]
        ...
        , HH.section
            ...
            , HH.p_
                [ HH.text "Hylograph is an experimental exploration of what data visualization APIs might look like in a strongly-typed functional programming language. It aims to preserve D3's flexibility while adding type safety and composability."
                ]
            , HH.p_
