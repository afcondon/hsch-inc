module Hylograph.Shared.Data where
...
dataFilePath FlareJSON = "./assets/data/flare-2.json"
...
dataFilePath MetroUnemploymentCSV = "./assets/data/bls-metro-unemployment.csv"
